...
/**
 * A VariableListener is an object that listens for VariableChangeEvents as sent by a
 * MonitorableVariableStore.
 *
 * @param <T>
 *            The Format of the underlying Variable to which the VariableListener is
 *            listening
 */
@FunctionalInterface
public interface VariableListener<T> extends EventListener
{
	 ...
	 * 
	 * @param vcEvent
	 *            The VariableChangeEvent indicating the change that took place to a
	 *            Variable
	 */
