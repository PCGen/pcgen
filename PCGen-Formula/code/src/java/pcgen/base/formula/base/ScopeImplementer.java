...
/**
 * A ScopeImplementer can return an ImplementedScope given a fully qualified scope name.
 */
@FunctionalInterface
public interface ScopeImplementer
{

	/**
	 * Returns the ImplementedScope for the given fully qualified scope name.
	 * 
	 * @param scopeName
