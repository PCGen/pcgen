...
public class ArraySubtractTest extends TestCase
{
	...
	public void testAbstractEvaluateMismatch()
	{
		...
		assertNull(op.abstractEvaluate(NUMBER_ARRAY_CLASS, NUMBER_CLASS,
			Optional.of(booleanArrayManager)));
		assertNull(op.abstractEvaluate(NUMBER_CLASS, NUMBER_ARRAY_CLASS,
			Optional.of(numberArrayManager)));
		assertNull(op.abstractEvaluate(BOOLEAN_CLASS, BOOLEAN_ARRAY_CLASS,
			Optional.of(booleanArrayManager)));
		assertNull(op.abstractEvaluate(NUMBER_CLASS, NUMBER_CLASS,
			Optional.of(numberArrayManager)));
		assertNull(op.abstractEvaluate(BOOLEAN_CLASS, BOOLEAN_CLASS,
			Optional.of(booleanArrayManager)));
	}
