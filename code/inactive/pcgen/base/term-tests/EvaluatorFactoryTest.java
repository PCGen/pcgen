...
public class EvaluatorFactoryTest extends PCGenTestCase {
	...
	public void testConstructor001() {
		...
		TestHelper.loadAll();
		Class<?> uClass = pcgen.base.term.EvaluatorFactory.class;
	...
	public void testGetTermEvaluator001() {
		...
		Field pF = (Field) TestHelper.findField(uClass, "originalText");
		...
		is(storedT, strEq(term), "GetTermEvaluator001 sored term correct " + term);	       
	}
	...
	public void testGetTermEvaluator082() {
		...
		Field pF0 = (Field) TestHelper.findField(uClass, "originalText");
		Field pF1 = (Field) TestHelper.findField(uClass, "aClass");
		...
		is(field1, strEq("Bard (Bardiliscious)"), "GetTermEvaluator082 field aClass is correct ");	       
	}
	...
	public void testGetTermEvaluator083() {
		...
		is(field1, strEq("Rogue (Sneaky)"), "GetTermEvaluator083 field aClass is correct ");	       
	}
	...
	public void testGetTermEvaluator086() {
		...
		is(field1, strEq("Ranger"), "GetTermEvaluator086 field aClass is correct ");	       
	}
	...
	public void testGetTermEvaluator088() {
		...
		is(field1, strEq("Bard"), "GetTermEvaluator088 field aClass is correct ");	       
	}
	...
	public void testGetTermEvaluator089() {
		...
		is(field1, strEq("Rogue"), "GetTermEvaluator089 field aClass is correct ");	       
	}
	...
	public void testGetTermEvaluator098() {
		...
		is(field1[0], strEq("IS"), "GetTermEvaluator098 field types[0] is correct ");	       
		is(field1[1], strEq("FOO"), "GetTermEvaluator098 field types[1] is correct ");	       
	...
	public void testGetTermEvaluator099() {
		...
		String term = "COUNT[EQTYPE.MERGELOC.NOT.BAR]";
		...
		is(field1[0], strEq("NOT"), "GetTermEvaluator099 field types[0] is correct ");	       
		is(field1[1], strEq("BAR"), "GetTermEvaluator099 field types[1] is correct ");	       
	...
	public void testGetTermEvaluator100() {
		...
		String term = "COUNT[EQTYPE.ADD.BAZ]";
		...
		is(field1[0], strEq("ADD"), "GetTermEvaluator100 field types[0] is correct ");	       
		is(field1[1], strEq("BAZ"), "GetTermEvaluator100 field types[1] is correct ");	       
	...
	public void testGetTermEvaluator103() {
		...
		is(t, eqnull(), "GetTermEvaluator103 evaluator is null");
	}
	...
	public void testGetTermEvaluator119() {
		...
		is(t, eqnull(), "GetTermEvaluator119 evaluator is null");
	}
	...
	public void testGetTermEvaluator120() {
		...
		String term = "COUNT[EQUIPMENT.MERGENONE.IS.FOO.QUX]";
	...
	public void testGetTermEvaluator121() {
		...
		String term = "COUNT[EQUIPMENT.MERGELOC.NOT.BAR.QUX]";
	...
	public void testGetTermEvaluator122() {
		...
		String term = "COUNT[EQUIPMENT.ADD.BAZ.QUX]";
	...
	public void testGetTermEvaluator195() {
		...
		is(t instanceof ConstantZeroTermEvaluator, eq(true),
		   "GetTermEvaluator195 evaluator correct for " + term);

		Class<?> uClass = ConstantZeroTermEvaluator.class;
		...
		is(ok, eq(true), "No illegal access in getTermEvaluator195");

		is(field0, strEq(term), "GetTermEvaluator195 stored term is correct " + term);	       
	}
	...
	public void testGetTermEvaluator196() {
		...
		is(t instanceof ConstantZeroTermEvaluator, eq(true),
		   "GetTermEvaluator196 evaluator correct for " + term);
		...
		is(ok, eq(true), "No illegal access in getTermEvaluator196");

		is(field0, strEq(term), "GetTermEvaluator196 stored term is correct " + term);	       
	}
	...
	public void testGetTermEvaluator197() {
		...
		is(t instanceof ConstantZeroTermEvaluator, eq(true),
		   "GetTermEvaluator197 evaluator correct for " + term);
		...
		is(ok, eq(true), "No illegal access in getTermEvaluator197");

		is(field0, strEq(term), "GetTermEvaluator197 stored term is correct " + term);	       
	}
	...
	public void testGetTermEvaluator198() {
		...
		is(t instanceof ConstantZeroTermEvaluator, eq(true),
		   "GetTermEvaluator198 evaluator correct for " + term);
		...
		is(ok, eq(true), "No illegal access in getTermEvaluator198");

		is(field0, strEq(term), "GetTermEvaluator198 stored term is correct " + term);	       
	}
	...
	public void testGetTermEvaluator199() {
		...
		is(t instanceof ConstantZeroTermEvaluator, eq(true),
		   "GetTermEvaluator199 evaluator correct for " + term);
		...
		is(ok, eq(true), "No illegal access in getTermEvaluator199");

		is(field0, strEq(term), "GetTermEvaluator199 stored term is correct " + term);	       
	}
	...
	public void testGetTermEvaluator200() {
		...
		is(t instanceof ConstantZeroTermEvaluator, eq(true),
		   "GetTermEvaluator200 evaluator correct for " + term);
		...
		is(ok, eq(true), "No illegal access in getTermEvaluator200");

		is(field0, strEq(term), "GetTermEvaluator200 stored term is correct " + term);	       
	}
