...
/**
 *  Resumes Refresh if a PauseRefresh message was sent
 *
 *@author     Soulcatcher
 *@since    May 23, 2003
 */
public class ResumeRefreshMessage extends GMBMessage
{
	/**
	 *  Constructor for the ResumeRefreshMessage object
	 *
	 *@param  comp Component sending the state changed message
	 */
	public ResumeRefreshMessage(GMBComponent comp)
	{
		super(comp);
	}
}
