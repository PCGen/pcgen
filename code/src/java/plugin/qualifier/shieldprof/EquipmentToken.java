...
public class EquipmentToken implements QualifierToken<ShieldProf>, Converter<Equipment, CDOMReference<ShieldProf>>
{
    ...
    @Override
    public boolean initialize(LoadContext context, SelectionCreator<ShieldProf> sc, String condition, String value,
            boolean negate)
    {
        if (negate)
        {
    ...
    public <R> Collection<R> getCollection(PlayerCharacter pc, Converter<ShieldProf, R> c)
    {
        ...
        Collection<? extends ObjectContainer<ShieldProf>> intermediate = pcs.getCollection(pc, this);
