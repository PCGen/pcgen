...
public class PreferencesNetworkingPanel extends gmgen.gui.PreferencesPanel {
  ...
  private JTextField userName;
	...
	public void applyPreferences() {
		SettingsHandler.setGMGenOption(NetworkPlugin.LOG_NAME + ".port", getPortNumber());
		SettingsHandler.setGMGenOption(NetworkPlugin.LOG_NAME + ".username", getUserName());
		model.applyPrefs();
	}

	public void initPreferences() {
		setPortNumber(SettingsHandler.getGMGenOption(NetworkPlugin.LOG_NAME + ".port", 80));
		setUserName(SettingsHandler.getGMGenOption(NetworkPlugin.LOG_NAME + ".username", "Player"));
	}
