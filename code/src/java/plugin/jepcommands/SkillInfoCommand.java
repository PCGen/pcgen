	...
	public void run(final Stack inStack) throws ParseException
	{
		...
		if ((param1 instanceof String) && (param2 instanceof String))
		{
			...
			if (aSkill != null && pc.getDisplay().hasSkill(aSkill))
			{
				...
				{
					result = (double) SkillModifier.modifier(aSkill, pc); // aSkill.modifier() returns Integer
				}
				...
				{
					result = (double) (SkillModifier.modifier(aSkill, pc) - SkillModifier.getStatMod(aSkill, pc));
				}
				else
				{
