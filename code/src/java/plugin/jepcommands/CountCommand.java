...
public class CountCommand extends PCGenCommand {
    ...
    public enum JepCountEnum {
        ABILITIES {
            ...
            public Object count(final PlayerCharacter pc, final Object[] params) throws ParseException {
            ...
            protected Set<PObject> filterSetP(final String c) {
                ...
                try {
                    ...
                    Logging.errorPrint("Bad paramter to count(\"Ability\"), " + c);
        ...
        CLASSES {
            ...
            protected Set<PObject> filterSetP(final String c) throws ParseException {
                final String[] keyValue = c.split("=");
        ...
        DOMAINS {
            ...
            protected void getData(final PlayerCharacter pc) {
                final Collection<CharacterDomain> domdata = new HashSet<CharacterDomain>();
            ...
            protected Set<String> filterSetS(final String kv) throws ParseException {
                ...
                final Iterable<CharacterDomain> cs = new HashSet<CharacterDomain>(objdata.keySet());
        ...
        EQUIPMENT {
            ...
            protected Set<PObject> filterSetP(final String c) throws ParseException {
                ...
                try {
                    ...
                    Logging.errorPrint("Bad paramter to count(\"Equipment\"), " + c);
                    return new HashSet<PObject>();
                }
...
//						}
        ...
        FOLLOWERS {
            ...
            // If we need to be able to filter out any of these followers, this is where
            // it should be done.
        ...
        LANGUAGES {
            ...
            protected Set<PObject> filterSetP(final String c) throws ParseException {
                ...
                if (!"TYPE".equalsIgnoreCase(keyValue[0])) {
                    throw new ParseException(
                            MessageFormat.format("Bad parameter to count(\"CLASSES\" ... ){0}", c));
                }
        ...
        RACESUBTYPES {
            ...
            protected Set<String> filterSetS(final String c)  throws ParseException {
                ...
                if (!"ALL".equalsIgnoreCase(keyValue[1])) {
                    ...
                    final Iterator<String> pcRaceSubTypeIterator = rSet.iterator();
        ...
        public abstract Object count(PlayerCharacter pc, Object[] params) throws ParseException;

        public Object countP(final PlayerCharacter pc, final Object[] params) throws ParseException {
            final Object[] par = validateParams(params);
            final ParameterTree pt = convertParams(par);
        ...
        public Object countS(final PlayerCharacter pc, final Object[] params) throws ParseException {
            final Object[] par = validateParams(params);
            final ParameterTree pt = convertParams(par);
     ...
     * @return an array of Objects in reverse order, i.e. the last param popped
