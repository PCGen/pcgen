 ...
 */
public class ArmorprofToken extends AbstractTokenWithSeparator<Campaign>
		implements CDOMPrimaryToken<Campaign>
{
	...
	protected ParseResult parseTokenWithSeparator(LoadContext context, Campaign campaign, String value)
	{
		...
		context.getObjectContext().addToList(campaign, ListKey.FILE_ARMOR_PROF, cse);
	...
	public String[] unparse(LoadContext context, Campaign campaign)
	{
		Changes<CampaignSourceEntry> cseChanges =
				context.getObjectContext().getListChanges(campaign, ListKey.FILE_ARMOR_PROF);
