 ...
 */
public class ArmorprofToken extends AbstractTokenWithSeparator<Campaign> implements CDOMPrimaryParserToken<Campaign>
{
	...
	protected ParseResult parseTokenWithSeparator(LoadContext context, Campaign campaign, String value)
	{
		...
		context.obj.addToList(campaign, ListKey.FILE_ARMOR_PROF, cse);
	...
	public String[] unparse(LoadContext context, Campaign campaign)
	{
		Changes<CampaignSourceEntry> cseChanges =
				context.obj.getListChanges(campaign, ListKey.FILE_ARMOR_PROF);
