 ...
 */
public class CodeControlToken extends AbstractTokenWithSeparator<Campaign>
		implements CDOMPrimaryToken<Campaign>
{
		...
		Campaign campaign, String value)
	{
		...
		context.getObjectContext().addToList(campaign, ListKey.FILE_CODECTRL,
			cse);
