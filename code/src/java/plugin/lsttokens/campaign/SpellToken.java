 ...
 */
public class SpellToken extends AbstractTokenWithSeparator<Campaign> implements CDOMPrimaryParserToken<Campaign>
{
		...
		Campaign campaign, String value)
	{
		...
		context.obj.addToList(campaign, ListKey.FILE_SPELL, cse);
	...
	public String[] unparse(LoadContext context, Campaign campaign)
	{
		Changes<CampaignSourceEntry> cseChanges =
				context.obj.getListChanges(campaign, ListKey.FILE_SPELL);
