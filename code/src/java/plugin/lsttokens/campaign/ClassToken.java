 ...
 */
public class ClassToken extends AbstractToken implements CDOMPrimaryToken<Campaign>
{
		...
		throws PersistenceLayerException
	{
		...
		context.obj.addToList(obj, ListKey.FILE_CLASS, cse);
		return true;
	}
	...
	public String[] unparse(LoadContext context, Campaign obj)
	{
		Changes<CampaignSourceEntry> cseChanges =
				context.obj.getListChanges(obj, ListKey.FILE_CLASS);
