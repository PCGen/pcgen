 ...
 *
 */
public class CskillToken extends AbstractTokenWithSeparator<PCClassLevel> implements
		CDOMPrimaryParserToken<PCClassLevel>, ChooseResultActor
{
			...
			PCClassLevel obj, String value)
	{
		...
		while (tok.hasMoreTokens())
		{
			...
			if (Constants.LST_DOT_CLEAR.equals(tokText))
			{
				...
				context.getObjectContext().removeList(obj, ListKey.PARENTCSKILL);
			}
			...
			else
			{
				...
				{
					foundAny = true;
					context.getObjectContext().addToList(obj, ListKey.PARENTCSKILL,
							context.ref.getCDOMAllReference(SKILL_CLASS));
				}
				else
				{
	...
	public void apply(PlayerCharacter pc, CDOMObject obj, String o)
	{
		...
		if (skill != null)
		{
			pc.addAssoc(obj, AssociationListKey.PARENTCSKILL, skill);
		}
	}
	...
	public void remove(PlayerCharacter pc, CDOMObject obj, String o)
	{
		...
		if (skill != null)
		{
			pc.removeAssoc(obj, AssociationListKey.PARENTCSKILL, skill);
		}
	}
