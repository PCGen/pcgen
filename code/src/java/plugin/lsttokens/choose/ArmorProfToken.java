...
public class ArmorProfToken extends ErrorParsingWrapper<CDOMObject> implements CDOMSecondaryParserToken<CDOMObject>
{
		...
		String value)
	{
		...
		StringTokenizer st = new StringTokenizer(value.substring(pipeLoc + 1),
				Constants.PIPE);
