...
/**
 * Code Control token that determines if
 */
public final class EqSizeToken extends AbstractStringStoringToken<CodeControl>
{
	@Override
	public String getTokenName()
	{
		return CControl.EQSIZE;
	}
