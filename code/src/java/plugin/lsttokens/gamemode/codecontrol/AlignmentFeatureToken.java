...
/**
 * CodeControl Token for the Alignment Feature.
 */
public class AlignmentFeatureToken extends AbstractNonEmptyToken<CodeControl>
        implements CDOMPrimaryToken<CodeControl>
{
    @Override
    public String getTokenName()
    {
        return CControl.ALIGNMENTFEATURE;
    }
    ...
    public String[] unparse(LoadContext context, CodeControl obj)
    {
        ...
        throw new UnsupportedOperationException("Cannot unparse ALIGNMENTFEATURE code control");
    }
}
