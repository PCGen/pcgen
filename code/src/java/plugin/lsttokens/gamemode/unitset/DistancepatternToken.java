...
public class DistancepatternToken extends AbstractNonEmptyToken<UnitSet> implements CDOMPrimaryToken<UnitSet>
{
    ...
    protected ParseResult parseNonEmptyToken(LoadContext context, UnitSet us, String value)
    {
        try
        {
            us.setDistanceDisplayPattern(new DecimalFormat(value));
    ...
    {
        return new String[]{us.getDistanceDisplayPattern().toPattern()};
    }
