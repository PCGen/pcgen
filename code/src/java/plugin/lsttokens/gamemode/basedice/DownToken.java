...
public class DownToken extends AbstractTokenWithSeparator<BaseDice> implements CDOMPrimaryToken<BaseDice>
{
    ...
    {
        return new String[]{StringUtil.join(bd.getDownSteps(), Constants.COMMA)};
    }
