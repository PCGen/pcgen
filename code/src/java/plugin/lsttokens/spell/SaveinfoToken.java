 ...
 */
public class SaveinfoToken extends AbstractTokenWithSeparator<Spell> implements CDOMPrimaryToken<Spell>
{
    ...
    protected ParseResult parseTokenWithSeparator(LoadContext context, Spell spell, String value)
    {
        ...
        while (aTok.hasMoreTokens())
        {
            ...
            {
                context.getObjectContext().addToList(spell, ListKey.SAVE_INFO, tok);
            }
            first = false;
        }
    ...
    {
        Changes<String> changes = context.getObjectContext().getListChanges(spell, ListKey.SAVE_INFO);
