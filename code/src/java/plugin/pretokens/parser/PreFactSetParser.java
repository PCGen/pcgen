...
/**
 * A prerequisite parser class that handles the parsing of pre factset tokens.
 */
public class PreFactSetParser extends AbstractPrerequisiteListParser
{
    /**
     ...
     * @param overrideQualify if set true, this prerequisite will be enforced in spite of
