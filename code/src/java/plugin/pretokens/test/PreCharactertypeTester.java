 ...
 *
 */
public class PreCharactertypeTester extends AbstractPrerequisiteTest implements PrerequisiteTest
{
	...
	{
		if (character.getDisplay().getCharacterType().equalsIgnoreCase(prereq.getKey()))
		{
