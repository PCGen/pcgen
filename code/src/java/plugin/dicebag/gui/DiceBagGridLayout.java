...
public class DiceBagGridLayout extends GridLayout
{
	...
	public void layoutContainer(Container parent)
	{
		...
		{
			int minWCols = (int) Math.floor((parent.getWidth() - getHgap() - parent.getInsets().left
				    - parent.getInsets().right) / (m_minSize + getHgap()));
			int maxWCols = (int) Math.floor((parent.getWidth() - getHgap() - parent.getInsets().left
				    - parent.getInsets().right) / (m_maxSize + getHgap()));
		...
		{
			int minWRows = (int) Math.floor((parent.getHeight() - getVgap() - parent.getInsets().top
				    - parent.getInsets().bottom) / (m_minSize + getVgap()));
			int maxWRows = (int) Math.floor((parent.getHeight() - getVgap() - parent.getInsets().top
				    - parent.getInsets().bottom) / (m_maxSize + getVgap()));
