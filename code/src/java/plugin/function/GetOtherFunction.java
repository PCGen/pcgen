...
public class GetOtherFunction implements Function
{
		...
		EvaluationManager manager)
	{
		...
		VarScoped vs = (VarScoped) args[1].jjtAccept(visitor, manager
			.getWith(EvaluationManager.ASSERTED, legalScope.getFormatManager(context)));
		...
		DependencyManager fdm, Node[] args)
	{
		...
		args[1].jjtAccept(visitor, fdm.getWith(DependencyManager.VARSTRATEGY, ts));
