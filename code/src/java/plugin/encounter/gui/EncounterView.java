...
public class EncounterView extends JPanel
{
	...
	private void initComponents()
	{
		...
		targetEncounterLevel
			.addActionListener(evt -> targetEncounterLevelActionPerformed(evt));
		...
		numberOfCreatures.addActionListener(evt -> numberOfCreaturesActionPerformed(evt));
		...
		generateEncounter.addActionListener(evt -> generateEncounterActionPerformed(evt));
