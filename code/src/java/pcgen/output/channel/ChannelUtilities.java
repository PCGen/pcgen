...
public final class ChannelUtilities
{
     ...
     *
     * @param id          The CharID representing the PC on which the channel should be read
     * @param channelName The name of the channel to be read
     ...
     *
     * @param id      The CharID representing the PC on which the channel should be read
     * @param control The Code Control which should be used to determine the channel name
     ...
     *
     * @param id          The CharID representing the PC on which the channel should be set
     * @param channelName The name of the channel to be set
     * @param value       The value to which the channel should be set, for the channel with the
     ...
     * @param id      The CharID representing the PC on which the channel should be set
     * @param control The Code Control which should be used to determine the channel name
     * @param value   The value to which the channel should be set, for the channel identified
     ...
     *
     * @param channelName The Channel name from which the channel variable name should be created
     ...
     *
     * @param id          The CharID on which the channel should be watched
     * @param channelName The name of the channel to be watched
     * @param listener    The listener to receive an event when the value of the channel changes
     */
     ...
     *
     * @param id          The CharID on which the channel should be no longer be watched
     * @param channelName The name of the channel to no longer be watched
     * @param listener    The listener to be removed from receiving an event when the value of the channel changes
     */
     ...
     * given CharID.
     *
     * @param id          The CharID representing the PlayerCharacter that the channel is on
     * @param channelName The name of the channel for which the VariableID should be returned
     ...
     *
     * @param pc          The PlayerCharacter on which the channel should be watched
     * @param codeControl The name of the channel to be watched
     * @param listener    The listener to receive an event when the value of the channel changes
     */
     ...
     * @param channelName The name of the channel to be watched
     * @param listener    The listener to receive an event when the value of the channel changes
     * @param priority    The priority of the listener for receiving changes (The lower the
     ...
     *
     * @param pc       The PlayerCharacter on which the listener will be added
     * @param control  The CodeControl indicating the channel on which the listener will be
     *                 added
     * @param listener the VariableListener to be added to listen to changes to the channel
     */
