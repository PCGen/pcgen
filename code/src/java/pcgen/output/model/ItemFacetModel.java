 ...
 *
 * @param <T> The Type of object contained in the ItemFacet contained by this
 *            ItemFacetModel
 */
public class ItemFacetModel<T> implements TemplateHashModel, TemplateScalarModel, Iterable<T>
{
     ...
     *
     * @param id    The underlying CharID used to get the PlayerCharacter's item
     *              from the given ItemFacet
     * @param facet The underlying ItemFacet used to get information about the
     *              PlayerCharacter
     */
