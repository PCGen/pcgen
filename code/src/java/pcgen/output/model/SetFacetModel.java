 ...
 *
 * @param <T> The Type of object contained in the SetFacet contained by this
 *            SetFacetModel
 */
public class SetFacetModel<T> implements TemplateSequenceModel, Iterable<T>
{
     ...
     *
     * @param id    The underlying CharID used to get items from the given
     *              SetFacet
     * @param facet The underlying SetFacet used to get information about the
     *              PlayerCharacter
     */
