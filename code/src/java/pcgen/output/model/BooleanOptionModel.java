...
public class BooleanOptionModel implements TemplateBooleanModel
{
     ...
     *
     * @param preferenceName The preference name underlying this BooleanOptionModel
     * @param defaultValue   The default value for the preference if not set in the options
     *                       panel
     */
