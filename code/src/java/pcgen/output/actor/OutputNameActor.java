 ...
 * output name of a CDOMObject into a TemplateModel.
 * 
...
{
	/**
	 * @see pcgen.output.base.OutputActor#process(CharID, java.lang.Object)
	 */
	@Override
		...
		throws TemplateModelException
	{
		...
		return ObjectWrapper.SIMPLE_WRAPPER.wrap(outputName);
	}
}
