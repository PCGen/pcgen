...
public interface CharacterFacade extends CompanionFacade
{
	 ...
	 */
    void addDomain(DomainFacade domain);

	/**
	 * Remove a domain from the list of those the character knows.
	 * @param domain The domain to remove.
	 */
    void removeDomain(DomainFacade domain);
	 ...
	 */
    void setXPTable(final String xpTableName);
	 ...
	 */
    void setAgeCategory(final String ageCat);
	 ...
	 */
    boolean isQualifiedFor(DomainFacade domain);
	 ...
	 */
    boolean getExportBioField(BiographyField field);
	 ...
	 */
    void setExportBioField(BiographyField field, boolean export);
	 ...
	 */
    Float getVariable(final String variableString, final boolean isMax);
