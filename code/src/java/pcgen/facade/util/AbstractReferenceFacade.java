 ...
 *
 * @param <T> The Type of object stored by this AbstractReferenceFacade
 */
        ...
        implements ReferenceFacade<T>
{
     ...
     * @param old    The old value of the reference underlying this AbstractReferenceFacade
     * @param newer  The new value of the reference underlying this AbstractReferenceFacade
     */
