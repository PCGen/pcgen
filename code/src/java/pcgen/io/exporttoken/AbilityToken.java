...
public class AbilityToken extends Token
{
     ...
     * @param aspect      The aspect which it must match.
     ...
     *
     * @param key The key of the wanted ability.
     ...
     * @param abilityIndex The location of the ability in the list.
     * @param aMapToList   The list of abilities to get the ability from.
     * @return The token value.
     */
