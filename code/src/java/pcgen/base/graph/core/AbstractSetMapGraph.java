		...
		Graph<N, ET>
{
	...
	/**
	 * Creates a new, empty AbstractSetMapGraph, using the given Class as the
	 * class used to store the information in the graph. This can be used, for
	 * example, to have the backing graph be an IdentityHashMap rather than a
	 * HashMap, in order to change the equality characteristics of the Graph.
	 */
	public AbstractSetMapGraph(Class<? extends Map> cl)
		throws InstantiationException, IllegalAccessException
	{
		super();
		edgeSet = new WrappedMapSet(cl);
		nodeMap = cl.newInstance();
		gcs = new GraphChangeSupport<N, ET>(this);
		nodeEdgeMap = cl.newInstance();
	}
