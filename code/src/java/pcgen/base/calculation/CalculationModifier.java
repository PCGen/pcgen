 ...
 *
 * @param <T> The format that this CalculationModifier acts upon
...
public final class CalculationModifier<T> extends AbstractPCGenModifier<T>
{
     ...
     * user priority first.
     *
     * @param calc The NEPCalculation to be performed by this CalculationModifier when it
     *             is processed
     * @throws IllegalArgumentException if the given NEPCalculation is null
     */
     ...
     * CalculationModifier.
     *
     * @param fm The FormatManager to check if it is equal to the FormatManager for this
     *           CalculationModifier
