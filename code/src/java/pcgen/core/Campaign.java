...
public final class Campaign extends PObject
{
	 ...
	 * @param files
	 */
	public void addAllAbilityFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllBioSetFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllClassFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllClassSkillFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllCoinFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllDeityFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllDomainFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllEquipFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllEquipModFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllFeatFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllKitFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllLanguageFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllLstExcludeFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllPccFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllRaceFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllReqSkillFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllSkillFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllSpellFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllTemplateFiles(final List files)
	{
	 ...
	 * @param files
	 */
	public void addAllWeaponProfFiles(final List files)
	{
	 ...
	 * @param file
	 */
	public void addReqSkillFile(final CampaignSourceEntry file)
	{
	...
	{
		String characteristic = stringChar.getCharacteristic(StringKey.BOOK_TYPE);
	 ...
	 * @return List
	 */
	public List getClassSkillFiles()
	{
	 ...
	 * @return List
	 */
	public List getClassSpellFiles()
	{
	...
	{
		String characteristic = stringChar.getCharacteristic(StringKey.DESTINATION);
		return characteristic == null ? "" : characteristic;
	}
	...
	public String getGameModeString()
	{
		...
		List gameModeList = getListFor(ListKey.GAME_MODE);

		for (Iterator i = gameModeList.iterator(); i.hasNext();)
		{
			final String gameMode = (String) i.next();
			sb.append(gameMode);
	...
	{
		String characteristic = stringChar.getCharacteristic(StringKey.GENRE);
		return characteristic == null ? "" : characteristic;
	}
	...
	{
		String characteristic = stringChar.getCharacteristic(StringKey.HELP);
		return characteristic == null ? "" : characteristic;
	}
	...
	{
		String characteristic = stringChar.getCharacteristic(StringKey.INFO_TEXT);
		return characteristic == null ? "" : characteristic;
	}
	...
	{
		List licenseList = getListFor(ListKey.LICENSE);
		StringBuffer sb = new StringBuffer();
		for(int i = 0; i < licenseList.size(); i++) {
			String license = (String)licenseList.get(i);
	...
	{
		String characteristic = stringChar.getCharacteristic(StringKey.PUB_NAME_LONG);
		return characteristic == null ? "" : characteristic;
	}
	...
	{
		String characteristic = stringChar.getCharacteristic(StringKey.PUB_NAME_SHORT);
		return characteristic == null ? "" : characteristic;
	}
	...
	{
		String characteristic = stringChar.getCharacteristic(StringKey.PUB_NAME_WEB);
		return characteristic == null ? "" : characteristic;
	}
	...
	public int getRank()
	{
		Integer characteristic = integerChar.getCharacteristic(IntegerKey.RANK);
	...
	{
		List licenseList = getListFor(ListKey.SECTION_15);
		StringBuffer sb = new StringBuffer();
		for(int i = 0; i < licenseList.size(); i++) {
			String license = (String)licenseList.get(i);
			sb.append(license).append("<br>");
	...
	{
		String characteristic = stringChar.getCharacteristic(StringKey.SETTING);
		return characteristic == null ? "" : characteristic;
	}
	 ...
	 * @return List
	 */
	public List getWeaponProfFiles()
	{
	 ...
	 * @return        boolean if present
	 **/
	public boolean isGameMode(final List gameModeList)
	{
		for (Iterator i = gameModeList.iterator(); i.hasNext(); )
		{
			final String gameMode = (String)i.next();
	...
	{
		stringChar.setCharacteristic(StringKey.BOOK_TYPE, bookType);
	}
	...
	{
		stringChar.setCharacteristic(StringKey.DESTINATION, destination);
	}
	...
	{
		stringChar.setCharacteristic(StringKey.GENRE, genre);
	}
	...
	{
		stringChar.setCharacteristic(StringKey.HELP, help);
	}
	...
	{
		stringChar.setCharacteristic(StringKey.INFO_TEXT, infoText);
	}
	...
	public void setPubNameLong(final String pubNameLong)
	{
		...
		stringChar.setCharacteristic(StringKey.PUB_NAME_LONG, pubNameLong);
	}
	...
	public void setPubNameShort(final String pubNameShort)
	{
		...
		stringChar.setCharacteristic(StringKey.PUB_NAME_SHORT, pubNameShort);
	}
	...
	public void setPubNameWeb(final String pubNameWeb)
	{
		...
		stringChar.setCharacteristic(StringKey.PUB_NAME_WEB, pubNameWeb);
	}
	...
	{
		integerChar.setCharacteristic(IntegerKey.RANK, rank);
	}
	...
	{
		stringChar.setCharacteristic(StringKey.SETTING, setting);
	}
	...
	{
		final String val = (String) publisherMap.get(key);
