...
public class MoveClone
{
	 ...
	 * 
	 * @param baseMovementType
	 *            The base MovementType for this MoveClone (e.g. "Walk").
	 * @param cloneMovementType
	 *            The target MovementType of the clone of movement for this MoveClone
	 *            (e.g. "Fly").
	 * @param conversion
	 *            The Function that performs the conversion from the base MovementType to
	 *            the cloned MovementType.
	 * @param formulaString
	 *            A String representation of the Function, so that it can be restored to
	 *            LST.
	 */
	 ...
	 * 
	 * @param baseMove
	 *            The baseMove value that should be converted by the conversion function
	 *            in this MoveClone
