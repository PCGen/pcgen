...
public class BonusManager
{
     ...
     *
     * @param nonStackMap             The map of non-stacking (i.e. highest wins) bonuses being built up.
     * @param stackMap                The map of stacking (i.e. total all) bonuses being built up.
     * @param fullyQualifiedBonusType The type of the bonus e.g. STAT.DEX:LUCK
     * @param targetMap               The map of bonuses (stack+non-stack) being built up which will be populated with the total bonus.
     */
     ...
     * @param prevProcessed    The list of bonuses which have already been processed in this
     *                         stack of calls to processBonus.
     * @param processedBonuses The list of bonuses which have already been processed overall.
     * @param nonStackMap      The map of non-stacking (i.e. highest wins) bonuses being built up.
     * @param stackMap         The map of stacking (i.e. total all) bonuses being built up.
     */
     ...
     * @param fullyQualifiedBonusType The type of the bonus e.g. STAT.DEX:LUCK
     * @param nonStackbonusMap        The map of non-stacking (i.e. highest wins) bonuses being built up.
     * @param stackingBonusMap        The map of stacking (i.e. total all) bonuses being built up.
     */
     ...
     *
     * @param fullyQualifiedBonusType The bonus key
