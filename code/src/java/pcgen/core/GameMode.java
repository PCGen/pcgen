...
public final class GameMode implements Comparable<Object>
{
     ...
     *
     * @param value For penalties set this to be a negative number, for bonuses to
     ...
     *
     * @param referenceContext The Reference Context into which the references from this
