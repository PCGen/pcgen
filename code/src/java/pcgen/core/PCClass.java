...
// PREDEFAULTMONSTER is deprecated, so anything with PREDEFAULTMONSTER:Y can be removed.
// On the other hand anything with PREDEFAULTMONSTER:N stay, but the PRE tag gets removed.
//
//				try
//				{
