...
public class PCClass extends PObject implements InfoFacade, Cloneable
{
     ...
     * @param aPC      The <tt>PlayerCharacter</tt> bonuses are being calculated
     *                 for.
     ...
     * @param bSilent       True if we are not to show any dialog boxes about errors or
     *                      questions.
     * @param aPC           The character we are adding the level to.
     * @param ignorePrereqs True if prereqs for the level should be ignored. Used in
