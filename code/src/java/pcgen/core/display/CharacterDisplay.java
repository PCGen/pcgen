...
public class CharacterDisplay
{
     ...
     * Spell Resistance.
     *
     * @param pct     The PCTemplate for which the Spell Resistance will be returned.
     ...
     * @param comp  the comparator that will be used to order the returned map.
     ...
     *
     * @param deity Deity to check for.
