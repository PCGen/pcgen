...
public class Prerequisite implements Cloneable
{
     ...
     *
     * @param val The value to set countMultiples to.
     */
     ...
     *
     * @param val The value to set kind to.
     */
     ...
     *
     * @param val The value to set the operand to.
     */
     ...
     *
     * @param operator The name of the operator to set in the object.
     ...
     *
     * @param override Whether to override the qualifications.
     */
