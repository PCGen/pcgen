...
public class AddObjectActions
{
	...
	public static void doBaseChecks(CDOMObject po, final PlayerCharacterImpl aPC)
	{
		aPC.setDirty(true);
	...
	public static void globalChecks(CDOMObject po, final PlayerCharacterImpl aPC)
	{
		doBaseChecks(po, aPC);
