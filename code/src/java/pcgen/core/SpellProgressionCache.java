...
public class SpellProgressionCache implements Cloneable
{
     ...
     *
     * @param iLevel The class level for which the given known spell progression
     *               applies.
     * @param aList  The known spell progression for the given class level.
     */
     ...
     *
     * @param aLevel The class level for which the known spell progression should
     *               be returned.
     ...
     *
     * @param aLevel The class level for which the given known specialty spell
     *               progression applies.
     * @param aList  The known specialty spell progression for the given class
     *               level.
     */
     ...
     * without impacting the internal contents of this SpellProgression)
     *
     * @param aLevel The class level for which the known specialty spell
     ...
     * within this SpellProgression.
     *
     * @param aLevel The class level for which the given CAST spell progression
     *               applies.
     * @param aList  The CAST spell progression for the given class level.
     ...
     * without impacting the internal contents of this SpellProgression)
     *
     * @param aLevel The class level for which the CAST spell progression should be
     *               returned.
     ...
     * in that case.
     *
     * @param spellLevel The spell level for which the minimum required class level
     *                   will be returned
     * @param allowBonus true if the class level is allowed to have a "0" CAST or KNOWN
     *                   spell count.
     ...
     * that spell level.
     *
     * @param classLevel The class level for which the theoretical maximum spell level
     *                   should be returned.
    ...
    private static class Progression implements Cloneable
    {
         ...
         *
         * @param iLevel The class level for which the given spell progression
         *               applies.
         * @param aList  The spell progression for the given class level.
         ...
         *
         * @param classLevel The class level for which the spell progression should be
         *                   returned.
