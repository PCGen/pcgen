...
public final class CustomData
{
	...
	public static void writePurchaseModeConfiguration()
	{
		...
		try
		{
			...
			{
				for (Map.Entry<Integer, PointBuyCost> integerPointBuyCostEntry : pbStatCosts.entrySet())
				{
					final PointBuyCost pbc = integerPointBuyCostEntry.getValue();
					bw.write("STAT:" + integerPointBuyCostEntry.getKey() + "\t\tCOST:" + Integer.toString(pbc.getBuyCost()));
