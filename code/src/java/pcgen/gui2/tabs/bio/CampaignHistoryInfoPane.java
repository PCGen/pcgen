	...
	private static class ChroniclePane extends JPanel implements ActionListener
	{
		...
		private void populateComponents()
		{
			...
			ActionListener actionListener =
					actionEvent -> entry.setOutputEntry(checkBox.getModel().isSelected());
			...
			xpField.addPropertyChangeListener("value",
					evt -> entry.setXpField(((Number) xpField.getValue()).intValue())
			);
