...
public class SummaryInfoTab extends JPanel implements CharacterInfoTab, TodoHandler
{
	...
	private final JComboBox<String> characterTypeComboBox;
	...
	private final JComboBox<String> xpTableComboBox;
	...
	private final JComboBox<String> handsComboBox;
	private final JComboBox<String> alignmentComboBox;
	private final JComboBox<String> deityComboBox;
	private final JComboBox<String> raceComboBox;
