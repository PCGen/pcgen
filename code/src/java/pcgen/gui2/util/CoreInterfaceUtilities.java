...
public final class CoreInterfaceUtilities
{
	 ...
	 * 
	 * @param id
	 *            The CharID representing the PlayerCharacter on which the variable is
	 *            located
	 * @param codeControl
	 *            The CodeControl indicating the variable for which the ReferenceFacade
	 *            should be returned
	 ...
	 *            located
	 * @param variableName
	 *            The Variable name for which the ReferenceFacade should be returned
