...
//			});
	...
	private void buildTopPanel()
	{
		...
		gridbag.setConstraints(addSpellPanel, c);
		leftPane.add(addSpellPanel);
...
//		Utility.buildConstraints(c, 0, 1, 2, 1, 1, 0, GridBagConstraints.HORIZONTAL,
//			GridBagConstraints.NORTH);
//		gridbag.setConstraints(slPanel, c);
//		rightPane.add(slPanel);
		
		// List of spell books Panel
	...
	protected void createAvailableModel()
	{
		if (availableModel == null)
		{
			availableModel = new SpellModel(primaryViewMode, secondaryViewMode,
				true, availableBookList, currSpellBook, false, pc, this);
		}
		else
		{
			availableModel.resetModel(primaryViewMode, secondaryViewMode, true,
				availableBookList, currSpellBook, false, this);
