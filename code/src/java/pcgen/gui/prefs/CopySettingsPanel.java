...
public class CopySettingsPanel extends PCGenPrefsPanel
{
	private static String in_copy_settings =
		PropertyFactory.getString("in_Prefs_copy");
	
	private JComboBoxEx gameModeSelect = new JComboBoxEx();
	private JButton copyButton =
			new JButton(PropertyFactory.getString("in_copy"));
	...
	public CopySettingsPanel()
	{
		...
		label = new JLabel(PropertyFactory.getString("in_Prefs_copyFrom"));
		...
		label =
				new JLabel(PropertyFactory.getFormattedString(
		...
		label = new JLabel(PropertyFactory.getString("in_Prefs_copyDesc"));
	...
	private final class CopyButtonListener implements ActionListener
	{
		...
		public void actionPerformed(ActionEvent actionEvent)
		{
			...
			//
			// Update affected character tabs
			//
			...
			if (characterPane != null)
			{
				...
				characterPane.setPaneForUpdate(characterPane.infoCharacterSheet());
			...
			ShowMessageDelegate.showMessageDialog(PropertyFactory
				.getString("in_Prefs_copyDone"), PropertyFactory
