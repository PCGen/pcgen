		...
		GenericLoader<T>
{
	 ...
	 * 
	 * @param cl
	 *            The class of object loaded by this GenericLocalVariableLoader
	 * @param varScope
	 *            The variable scope in which the objects are loaded
	 */
	public GenericLocalVariableLoader(Class<T> cl, String varScope)
	{
		super(cl);
		this.varScope = Objects.requireNonNull(varScope);
	}
