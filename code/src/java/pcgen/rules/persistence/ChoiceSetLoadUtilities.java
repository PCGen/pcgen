...
public final class ChoiceSetLoadUtilities
{
     ...
     * given LoadContext.
     *
     * @param context The LoadContext in which the given GroupingInfo will be interpreted
     * @param info    The GroupingInfo that contains the instructions for what the returned
