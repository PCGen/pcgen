...
public final class TokenLibrary implements PluginLoader
{
     ...
     *
     * @param definition The GroupingDefinition to be added to this TokenLibrary
     */
     ...
     *
     * @param token The QualifierToken to be added to this TokenLibrary
     */
     ...
     *
     * @param name The name of the CDOMInterfaceToken to be returned
