 ...
 *
 * @param <C> The Class of object for which this TokenFamilySubIterator is
...
public class TokenFamilySubIterator<C> implements Iterator<CDOMSecondaryToken<? super C>>
{
     ...
     * token name.
     *
     * @param cl         The Class for which this TokenFamilySubIterator will return
     *                   CDOMSecondaryTokens.
     * @param parentName The name of the parent token for which the CDOMSecondaryTokens
     *                   will be returned
     */
