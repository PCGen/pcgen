 ...
 * 
 * @param <T>
 *            The type of object upon which the DeferredToken operates
 */
public interface DeferredToken<T extends Loadable>
{
	 ...
	 * 
	 * @param context
	 *            The LoadContext around which this DeferredToken is evaluated
	 * @param obj
	 *            The object to be processed in this DeferredToken
