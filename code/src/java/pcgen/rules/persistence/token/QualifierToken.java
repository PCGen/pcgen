 ...
 *
 * @param <T> The Type of object processed by the QualifierToken
 */
public interface QualifierToken<T extends CDOMObject> extends LstToken, PrimitiveCollection<T>
{
     ...
     * @param cl        The SelectionCreator used to get objects on which this
     *                  QualifierToken is operating
     * @param condition The condition of the qualifier; may be null if no condition
     * @param value     The value of the qualifier
     * @param negated   true if the PrimitiveCollection should be negated; false
     *                  otherwise
