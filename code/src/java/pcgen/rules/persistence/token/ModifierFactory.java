 ...
 *
 * @param <T> The object type of the Modifiers built by this ModifierFactory
 */
public interface ModifierFactory<T>
{
     ...
     *
     * @param instructions  The String form of the instructions of the FormulaModifier to be
     *                      returned
     * @param formatManager The FormatManager for the FormulaModifier to be returned
     ...
     *
     * @param formatManager The FormatManager for the FormulaModifier to be returned
     * @param instructions  The String form of the instructions of the FormulaModifier to be returned
     * @return a FormulaModifier with the given instructions
     */
