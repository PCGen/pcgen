...
public class TableLoader extends LstLineFileLoader
{
    ...
    public interface LineProcessor
    {
         ...
         * sourceURI).
         *
         * @param context   The LoadContext to be used for interpretation of the Table
         *                  file
         * @param lstLine   The line of the Table file to be processed
         * @param sourceURI The URI indicating the file being processed
         * @return The LineProcessor that should be responsible for interpreting
         * the next line of the file
         * @throws PersistenceLayerException if there is an error during the loading of the given line
         */
     ...
     * the CSV file format.
     *
     * @param entry The entry to be unescaped into its base state
     ...
     *
     * @param line The line being processed (for debugging purposes only)
     * @param ps   The ParsingSeparator that should only return "blank" entries
     * @throws PersistenceLayerException if there is any non-blank content returned by the
     *                                   ParsingSeparator
     */
     ...
     * acceptable.
     *
     * @param lstLine The line to be processed by a CSV-like ParsingSeparator
    ...
    private static class ImportColumnNames implements LineProcessor
    {
         ...
         *
         * @param table The underlying Table to which the column names should be
         *              assigned
         */
    ...
    private static class ImportColumnFormats implements LineProcessor
    {
         ...
         *
         * @param table       The underlying Table to which the formats should be
         *                    assigned
         * @param columnNames
         */
    ...
    private static class ImportData implements LineProcessor
    {
         ...
         *
         * @param table The underlying Table to which the data will be loaded
         */
