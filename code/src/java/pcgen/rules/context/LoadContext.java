...
public interface LoadContext
{
     ...
     *
     * @param loadable The loadable object to be unparsed into the tokens used to persist the
     *                 object
     ...
     * FACTSETDEF
     *
     * @param token The "local" token to be loaded into this LoadContext
     */
     ...
     *
     * @param formatManager The FormatManager to indicate the format of the NEPFormula to be
     *                      returned
     * @param instructions  The instructions for the NEPFormula to process when it is solved
     ...
     * called.
     *
     * @param controller The DeferredMethodController to be added to this LoadContext
     */
     ...
     *
     * @param scope        The scope used to determine the contents of the Grouping
     * @param instructions The instructions used to determine the contents of the Grouping
