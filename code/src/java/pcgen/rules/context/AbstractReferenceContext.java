...
public abstract class AbstractReferenceContext
{
     ...
     * ClassIdentity.
     *
     * @param classIdentity The ClassIdentity to be checked to see if this AbstractReferenceContext
     ...
     *
     * @param obj The object for which a CDOMSingleRef should be returned
     ...
     *
     * @param classIdentity The ClassIdentity for which the ReferenceManufacturer should be returned
     ...
     * to do so.
     *
     * @param factory The ManufacturableFactory for which the ReferenceManufacturer should be
     *                returned
     ...
     *
     * @param cl The Class of object to return
     ...
     *
     * @param formatName The (persistent) name of the format for which the ReferenceManufacturer
     *                   should be returned
     * @param cl         The class, indicating additional information about the
