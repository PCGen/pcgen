...
public class ChangeArmorType implements Processor<String>
{
     ...
     *
     * @param sourceType The source type for this ChangeArmorType, to be tested against
     *                   the types provided in applyProcessor
     * @param resultType The result type for this ChangeArmorType, to be returned from
     *                   applyProcessor if the Processor acts on the incoming type. May
     *                   be null to indicate this ChangeArmorType should remove the
     *                   source armor type
     * @throws IllegalArgumentException if the given source type is null
     */
     ...
     *
     * @param sourceType The input armor type this Processor will act upon
     * @param context    The context of this Processor, ignored by ChangeArmorType.
     ...
     * method.
     *
     * @param armorTypes The list of input armor types this Processor will act upon
