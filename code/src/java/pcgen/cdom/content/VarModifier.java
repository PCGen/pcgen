 ...
 *
 * @param <T> The format of the variable modified by the FormulaModifier in this
 *            VarModifier
 */
public class VarModifier<T>
{
     ...
     * modify a variable.
     *
     * @param varName    The name of the Variable to be modified when this VarModifier
     *                   is applied
     * @param legalScope the PCGenScope in which the Modifier is applied
     * @param modifier   The FormulaModifier to be applied to the Variable when this
