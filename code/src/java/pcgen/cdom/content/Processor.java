 ...
 *
 * @param <T> The class of object this Processor acts upon.
 */
public interface Processor<T>
{
     ...
     *
     * @param obj     The input object this Processor will act upon
     * @param context The context of this Processor, to establish (if necessary),
