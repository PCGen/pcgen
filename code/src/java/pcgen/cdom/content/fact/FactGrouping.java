 ...
 * 
 * @param <T>
 *            The Type of object contained in this FactGrouping
 * @param <F>
...
public class FactGrouping<T extends CDOMObject, F> implements GroupingCollection<T>
{
	 ...
	 * 
	 * @param fi
	 *            The FactInfo indicating the underlying characteristics of the Fact that
	 *            this FactGroup will check
	 * @param info
	 *            The GroupingInfo of the value that this FactGrouping will be looking for
	 */
