...
public class LevelCommandFactory extends ConcretePrereqObject implements Comparable<LevelCommandFactory>
{
     ...
     * levels
     *
     * @param classRef A Reference to the PCClass to be applied to the
     *                 PlayerCharacter when this LevelCommandFactory is executed.
     *                 This reference must be resolved before the LevelCommandFactory
     *                 can be executed.
     * @param lvls     A Formula indicating the number of levels to be applied to the
     *                 PlayerCharacter when this LevelCommandFactory is executed.
     * @throws IllegalArgumentException if the given Reference or Formula is null
     */
     ...
     *
     * @param other The LevelCommandFactory to be compared to this
     *              LevelCommandFactory.
     ...
     * @throws NullPointerException if the given LevelCommandFactory is null
     */
    @Override
