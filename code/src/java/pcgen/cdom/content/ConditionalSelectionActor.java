...
public class ConditionalSelectionActor<T> extends ConcretePrereqObject implements ChooseSelectionActor<T>
{
     ...
     *
     * @param csa The ChooseSelectionActor to be applied to a PlayerCharacter if
     ...
     *
     * @param cdo    The CDOMObject to which the choice was applied (the CDOMObject
     ...
     * @param cdo    The CDOMObject to which the choice was applied (the CDOMObject
     *               on which the CHOOSE token was present)
     * @param choice The choice being removed from the given PlayerCharacter
     ...
     * @throws PersistenceLayerException if there is a problem converting this
