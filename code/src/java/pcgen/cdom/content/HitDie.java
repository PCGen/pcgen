...
public class HitDie extends ConcretePrereqObject implements Comparable<HitDie>
{
     ...
     *
     * @param dieSize The die size for this HitDie
     * @throws IllegalArgumentException if the given die size is negative
     */
     ...
     *
     * @param other The HitDie to be compared to this HitDie.
