 ...
 * the calculation.
 *
 * @param <T> The format of object on which this IndirectCalculation operates
 */
public final class IndirectCalculation<T> extends AbstractNEPCalculation<T>
{
     ...
     *
     * @param object The Indirect pointing to the object to be passed into the given
     *               BasicCalculation when this IndirectCalculation is processed
     * @param calc   The BasicCalculation which defines the operation to be performed when
