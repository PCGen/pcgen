 ...
 *
 * @param <T> The type of object on which this ContentDefinition is legal to use
 *            (in LST files)
 * @param <F> The type of object used as content in the items managed by this
 *            ContentDefinition
 */
public abstract class ContentDefinition<T extends CDOMObject, F> extends UserContent
{
     ...
     *
     * @param name The DisplayName for this UserContent
     ...
     *
     * @param cl The Class indicating the "usable location" of this
     *           ContentDefinition
     */
     ...
     * files.
     *
     * @param fmtManager The non-null FormatManager for this ContentDefinition
     * @return The previous FormatManager for this ContentDefinition.
     * @throws IllegalArgumentException if the given FormatManager is null
     */
     ...
     * HIDDEN.
     *
     * @param vis The visibility for this ContentDefinition
     */
     ...
     *
     * @param set A boolean value indicating whether this ContentDefinition is
     *            selectable
     */
     ...
     * @param set A boolean value indicating whether this ContentDefinition is
     *            Required
     * @throws UnsupportedOperationException if the set parameter is true and the "Usable Location" of
     ...
     *
     * @param context The LoadContext to initialize with tokens, if required
     */
     ...
     * This should not be called from an external source
     *
     * @param dsID The DataSetID for which the output should be activated
     */
