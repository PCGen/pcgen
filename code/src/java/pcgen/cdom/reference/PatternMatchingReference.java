 ...
 *
 * @param <T> The class of object underlying this PatternMatchingReference.
 */
public class PatternMatchingReference<T extends Loadable> extends CDOMReference<T>
{
     ...
     * @param patternText   The pattern used to identify items which this
     ...
     *
     * @param item ignored
     * @throws IllegalStateException because a PatternMatchingReference is resolved based on the
