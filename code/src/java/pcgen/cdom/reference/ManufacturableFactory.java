 ...
 *
 * @param <T> The Format (class) of object that this ManufacturableFactory creates. Note
...
public interface ManufacturableFactory<T extends Loadable> extends SelectionCreator<T>
{
     ...
     *
     * @param item The item to be checked to see if is potentially created by this
     *             ManufacturableFactory
     ...
     *
     * @param rm        The ReferenceManufacturer that should be used to resolve the given
     *                  CDOMSingleRef
     * @param name      The name of the object to be loaded into the CDOMSingleRef
     * @param reference The CDOMSingleRef that will be resolved during this method call
     * @param validator The UnconstructedValidator that will be checked to determine if the
     ...
     * to see if they are permissible errors.
     *
     * @param parent    The parent ReferenceManufacturer from which references can be pulled
     * @param rm        The ReferenceManufacturer for which references will be populated
     * @param validator The UnconstructedValidator that will be checked to determine if the
     *                  given object is permitted to be unconstructed
