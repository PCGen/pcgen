...
public class SpellCasterChoiceSet extends ChoiceSet<PCClass> implements PrimitiveChoiceSet<PCClass>
{
     ...
     * given List.
     *
     * @param allRef    The "ALL" Reference for PCClass objects
     * @param spelltype A List of spell types that this SpellCasterChoiceSet will
     *                  allow to be used to select a PCClass
     * @param typePCS   A PrimitiveChoiceSet which defines the Set of objects
     *                  contained within the SpellCasterChoiceSet that were referenced
     *                  by group (e.g. TYPE=)
     * @param primPCS   A PrimitiveChoiceSet which defines the Set of primitive
