...
public final class InfoUtilities
{
	 ...
	 * 
	 * @param id
	 *            The CharID identifying the PlayerCharacter for which the array is being
	 *            retrieved
	 * @param cdo
	 *            The CDOMObject on which the INFOVARS item is being retrieved
	 * @param cis
	 *            The CaseInsensitiveString identifying the specific INFOVARS item on the
