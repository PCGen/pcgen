        ...
        implements QualifyingObject, ChooseSelectionActor<AbilitySelection>
{
     ...
     *
     * @param token The Ability which this AbilitySelection will contain
     * @param cat   The Ability category which this AbilitySelection will contain
     * @param nat   The Nature of the given Ability as it should be applied to a
     *              PlayerCharacter
     */
