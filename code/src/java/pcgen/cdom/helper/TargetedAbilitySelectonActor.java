 ...
 */
public class TargetedAbilitySelectonActor<T extends Loadable> extends ConcretePrereqObject
		implements QualifyingObject, ChooseSelectionActor<T>
{
	 ...
	 *            PlayerCharacter
	 */
	public TargetedAbilitySelectonActor(String token, Category<Ability> cat,
	...
	{
		CategorizedAbilitySelection appliedSelection =
				new CategorizedAbilitySelection(obj, category,
					ability.resolvesTo(), nature, choice.getKeyName());
	...
	{
		if (o instanceof TargetedAbilitySelectonActor)
		{
			TargetedAbilitySelectonActor other =
					(TargetedAbilitySelectonActor) o;
			return source.equals(other.source)
				&& category.equals(other.category)
				&& ability.equals(other.ability) && nature.equals(other.nature);
		}
		return false;
	}
