...
public class WeaponProfProvider extends ConcretePrereqObject implements QualifyingObject
{
     ...
     *
     * @param ref The primitive WeaponProf reference that should be added to
     ...
     *
     * @param ref The WeaponProf TYPE reference that should be added to this
     *            WeaponProfProvider
     */
     ...
     *
     * @param ref The WeaponProf ALL reference that should be added to this
     *            WeaponProfProvider
     */
     ...
     *
     * @param id The PlayerCharacter used to resolve the references in order to
