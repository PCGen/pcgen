...
public abstract class AbstractProfProvider<T extends CDOMObject> extends ConcretePrereqObject implements ProfProvider<T>
{
     ...
     *
     * @param profs      The List of proficiency references indicating the primitive
     ...
     *
     * @param equipment The Equipment to be tested to see if this AbstractProfProvider
     ...
     *
     * @param typeString The TYPE of Equipment to be tested to see if this
