...
public class ClassSkillChoiceActor implements PersistentChoiceActor<Skill>
{
     ...
     * skills.
     *
     * @param pcc      The PCClass to which skill selections will be applied as a
     *                 class skill
     * @param autoRank The number of ranks that this ClassSkillChoiceActor should
     ...
     * @param choice The Skill which should be added as a Class Skill for the
     *               PCClass provided during construction of this
     *               ClassSkillChoiceActor
     * @param pc     The PlayerCharacter to which the changes driven by this
     ...
     *
     * @param choice     The Skill to be tested to see if selection of the Skill should
     *                   be allowed for this ClassSkillChoiceActor.
     * @param pc         The PlayerCharacter to which the changes driven by this
     *                   ClassSkillChoiceActor will be applied.
     * @param allowStack True if stacking is allowed (ignored by ClassSkillChoiceActor)
     ...
     *
     * @param persistentFormat The String which should be decoded to provide a Skill.
     ...
     *
     * @param choice The Skill which should be encoded into a String sufficient to
     *               identify the Skill.
     ...
     *
     * @param pc     The PlayerCharacter to which the Skill should be restored.
     * @param owner  The owning object of the Skill being restored.
     * @param choice The Skill being restored to the given PlayerCharacter.
     */
    @Override
     ...
     *
     * @param pc     The PlayerCharacter from which the Skill should be removed.
     * @param owner  The owning object of the Skill being removed.
     * @param choice The Skill being removed from the given PlayerCharacter.
     */
    @Override
