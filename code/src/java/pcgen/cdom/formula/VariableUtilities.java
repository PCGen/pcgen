...
public final class VariableUtilities
{
     ...
     * given CharID.
     *
     * @param id           The CharID representing the PlayerCharacter that the variable is on
     * @param variableName The name of the variable for which the VariableID should be returned
     ...
     *
     * @param id           The CharID on which the variable should be watched
     * @param variableName The name of the variable to be watched
     * @param listener     The listener to receive an event when the value of the variable changes
     */
     ...
     *
     * @param id           The CharID on which the variable should be no longer be watched
     * @param listener     The listener to be removed from receiving an event when the value of the
     *                     variable changes
     * @param variableName The name of the variable to no longer be watched
     */
     ...
     *
     * @param id       The CharID on which the change is occurring
     * @param vcEvent  the VariableChangeEvent
     * @param listener The DataFacetChangeListener
     */
     ...
     *
     * @param id        The CharID representing the PlayerCharacter that the variable is
     *                  contained within
     * @param scopeInst The ScopeInstance representing the object that the variable is on
     * @param name      The name of the variable for which the VariableID should be returned
     ...
     * @param id    The CharID representing the PlayerCharacter that the variable is
     *              contained within
     * @param owner The owning VarScoped object that the variable is on
     * @param name  The name of the variable for which the VariableID should be returned
