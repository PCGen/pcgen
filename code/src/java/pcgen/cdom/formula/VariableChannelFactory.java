...
public interface VariableChannelFactory
{
     ...
     *
     * @param id   The CharID identifying the PlayerCharacter on which the Channel resides
     ...
     *
     * @param id    The CharID identifying the PlayerCharacter on which the Channel resides
     * @param owner The owning object of the Channel
     * @param name  The name of the channel
     ...
     *
     * @param variableChannel The VariableChannel to be disconnected from its VariableStore
     */
