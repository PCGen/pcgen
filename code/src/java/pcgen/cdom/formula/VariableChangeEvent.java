 ...
 *
 * @param <T> The Format of the underlying Variable for which the
...
public class VariableChangeEvent<T> extends EventObject
{
     ...
     * and old/new values.
     *
     * @param source The source object of the VariableChangeEvent
     * @param varID  The VariableID indicating which variable changed for this
     *               VariableChangeEvent
     * @param old    The previous value of the variable prior to the change being
     *               indicated by this VariableChangeEvent
