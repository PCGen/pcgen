...
public class ClassFacet extends AbstractDataFacet<CharID, PCClass> implements SetFacet<CharID, PCClass>
{
     ...
     * @param obj The PCClass to be added to the list of PCClass objects stored
     ...
     *
     * @param id  The CharID representing the Player Character for which the given
     *            PCClassLevel should be set
     * @param pcc The PCClass object for which the PCClassLevel object is set as the
     *            PCClass
     * @param pcl The PCClassLevel object to be associated with the given PCClass and
     *            Player Character represented by the given CharID
     * @return true if the set is successful; false otherwise.
     * @throws CloneNotSupportedException if the class level cannot be thrown
     */
     ...
     * @param obj   The PCClass object for which the PCClassLevel object should be
     *              returned
     * @param level The (numeric) class level for which the PCClassLevel object
     *              should be returned
     ...
     * @param obj The PCClass to be removed from the list of PCClass objects
     ...
     * @param oldClass The old PCClass to be removed from the list of PCClass objects
     *                 stored in this ClassFacet for the Player Character represented
     *                 by the given CharID
     * @param newClass The new PCClass to replace the old PCClass stored in this
     ...
     * @param obj The PCClass to test if this ClassFacet contains that PCClass
     ...
     *
     * @param id    The CharID identifying the Player Character for which a level
     *              value is being set
     * @param pcc   The PCClass identifying which class level is being set
     * @param level The level of the PCClass for the Player Character identified
     *              by the given CharID
     */
     ...
     * @param pcc The PCClass for which the level of the Player Character should
     *            be returned
     ...
     *
     * @param id The CharID for which the ClassInfo should be returned
    ...
    public static class ClassLevelChangeSupport
    {
         ...
         *
         * @param listener The LevelChangeListener to receive LevelChangeEvents
         */
        public void addLevelChangeListener(ClassLevelChangeListener listener)
        {
         ...
         *
         * @param listener The LevelChangeListener to be removed
         */
        public void removeLevelChangeListener(ClassLevelChangeListener listener)
        {
         ...
         *
         * @param id       The CharID that has beed added to or removed from the source
         *                 ClassFacet
         * @param pcc      The PCClass to be added to the list of PCClass objects stored
         *                 in this AbstractListFacet for the Player Character represented
         *                 by the given CharID
         * @param oldLevel The chracter's previous level
         * @param newLevel The new level specified by the user.
         */
