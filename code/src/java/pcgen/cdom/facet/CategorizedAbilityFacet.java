...
public class CategorizedAbilityFacet extends AbstractDataFacet<CharID, Ability>
{
     ...
     * @param cat The Ability Category identifying the list to which the given
     *            Ability should be added
     * @param nat The Ability Nature identifying the list to which the given
     *            Ability should be added
     * @param obj The Ability to be added to the list of Abilities defined by
     ...
     * @param nature    The Ability Nature identifying the list to which the given
     *                  Abilities should be added
     * @param abilities The Collection of Abilities to be added to the list of
     ...
     * @param cat The Ability Category identifying the list from which the given
     *            Ability should be removed
     * @param nat The Ability Nature identifying the list from which the given
     *            Ability should be removed
     * @param obj The Ability to be removed from the list of Abilities defined
     ...
     * @param cat The Ability Category identifying the list of Abilities to be
     *            returned
     * @param nat The Ability Nature identifying the list of Abilities to be
     *            returned
     ...
     * @param nat The Ability Nature identifying the list of Abilities to be
     *            tested to see if it contains the given Ability
     * @param a   The Ability to test if this CategorizedAbilityFacet contains
     ...
     * @param cat The Ability Category identifying which Ability objects are to
     ...
     *               CategorizedAbilityFacet for the Player Character represented
     *               by the given CharID
     * @param nature The Ability Nature identifying which Ability objects are to be
