...
public class LevelFacet extends AbstractStorageFacet<CharID> implements ClassLevelChangeListener
{
     ...
     * by the given CharID.
     *
     * @param id The CharID of the Player Character for which the non-Monster
     ...
     * the given CharID.
     *
     * @param id The CharID of the Player Character for which the Monster level
     ...
     * given CharID.
     *
     * @param id The CharID of the Player Character for which the level
     ...
     *
     * @param listener The LevelChangeListener to receive LevelChangeEvents from this
     *                 LevelFacet
     */
     ...
     * receive events from this LevelFacet.
     *
     * @param listener The LevelChangeListener to no longer receive LevelChangeEvents
    ...
    public static class LevelChangeSupport
    {
         ...
         *
         * @param id An identifier indicating the Player Character on which a
