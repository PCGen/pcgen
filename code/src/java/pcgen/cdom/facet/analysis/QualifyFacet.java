...
public class QualifyFacet extends AbstractStorageFacet<CharID> implements DataFacetChangeListener<CharID, CDOMObject>
{
    ...
    private static class CacheInfo
    {
         ...
         *
         * @param q      The Qualifier to be added to this CacheInfo
         * @param source The source for the Qualifier being added to this CacheInfo
         */
         ...
         *
         * @param object The source CDOMObject for which all Qualifier objects will
         ...
         *
         * @param qualTestObject The CDOMObject to check if the Player Character has been
