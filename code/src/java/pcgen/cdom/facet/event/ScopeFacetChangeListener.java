 ...
 * @param <S>   The Type of object of the scope of the SubScopeFacetChangeListener
 * @param <T>   The Type of object changed in the events received by a
 *              ScopeFacetChangeListener
 */
public interface ScopeFacetChangeListener<IDT extends PCGenIdentifier, S, T> extends EventListener
{
     ...
     *
     * @param dfce The ScopeFacetChangeEvent that occurred.
     */
