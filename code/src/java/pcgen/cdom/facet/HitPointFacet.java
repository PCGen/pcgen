        ...
        implements DataFacetChangeListener<CharID, CDOMObject>
{
     ...
     * @param pcClass    The PCClass for which the HitDie will be returned
     * @param classLevel The level for which the HitDie will be returned
     ...
     *
     * @param id    The CharID identifying the Player Character on which the hit
     *              points are to be rolled
     * @param pcc   The PCClass for which the hit points are to be rolled
     * @param level The class level for which the hit points are to be rolled
     * @param first And identifier indicating if this is the Player Character's
     *              first level.
     */
