        ...
        implements DataFacetChangeListener<CharID, PCTemplate>
{
     ...
     *
     * @param id The CharID for which the RegionCacheInfo should be returned
     ...
     *               Region will be set
     * @param region The Region for the Player Character represented by the given
     *               CharID
     */
     ...
     * @param subregion The SubRegion for the Player Character represented by the
     *                  given CharID
     */
     ...
     * CharID.
     *
     * @param id The CharID representing the Player Character for which the Region should
     *           be returned.
     ...
     *           Character's Region.
     * @param r  The Region to be tested to determine if it matches the Player
     *           Character's Region
