...
public class SkillRankFacet extends AbstractStorageFacet<CharID>
{
     ...
     *
     * @param id The CharID for which the CacheInfo should be returned
    ...
    public static class SkillRankChangeSupport
    {
         ...
         *
         * @param listener The LevelChangeListener to receive SkillRankChangeEvents
         */
         ...
         *
         * @param id      The CharID on which the skill rank change has taken place
         * @param sk      The Skill to be added to the list of PCClass objects
         *                stored in this Facet for the Player Character represented
         *                by the given CharID
         * @param oldRank The character's previous rank for the given skill
         * @param newRank The character's new rank for the given skill.
         */
