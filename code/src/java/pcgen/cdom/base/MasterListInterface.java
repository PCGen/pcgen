...
public interface MasterListInterface
{
     ...
     *
     * @param <T>  The type of object contained within the List for which the
     *             associations are being returned
     * @param key1 A CDOMReference containing one or more CDOMLists for which the
     *             associations for the given Object should be returned
     * @param key2 The CDOMObject for which the associations on the lists
     ...
     * @param <T>  The type of object contained within the List for which the
     *             associations are being returned
     * @param key1 A CDOMList for which the associations for the given Object
     *             should be returned
     * @param key2 The CDOMObject for which the associations on the CDOMList
     *             should be returned
     * @return a Collection of AssociatedPrereqObjects containing the
     * associations for the given list and the given Object on the list.
     */
