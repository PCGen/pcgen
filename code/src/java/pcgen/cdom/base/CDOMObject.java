        ...
        VarContainer
{
     ...
     * to the class calling this method.
     *
     * @param key The ListKey for which a Set of the objects stored in this
     ...
     *
     * @param mapKey The MapKey for retrieving the given value
     * @param key2   The secondary key for retrieving the given value
     ...
     *
     * @throws CloneNotSupportedException hypothetically
     */
     ...
     *
     * @param childType The child type for which the child should be returned
     * @param childName The name of the child of the given type that should be returned
     ...
     *
     * @param childType The child type for which the list of children should be returned
