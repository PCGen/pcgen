 ...
 * 
 * @param <IDT>
 *            The Identifier Type used to set and store objects from the
 *            SetFacet
 * @param <T>
 *            The Type of objects stored (per identifier) in the SetFacet
 */
public interface SetFacet<IDT, T>
{
	 ...
	 * 
	 * @param id
	 *            The identifier used to identify the objects for which the
