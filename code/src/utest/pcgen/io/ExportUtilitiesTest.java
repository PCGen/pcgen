...
public class ExportUtilitiesTest
{
	...
	{
		assertFalse("Should not be PDF", ExportUtilities.isPdfTemplate(new File("foo.html")));
		assertFalse("Should not be PDF", ExportUtilities.isPdfTemplate(new File("foo.htm")));
		assertFalse("Should not be PDF", ExportUtilities.isPdfTemplate(new File("foo.xml")));

		assertFalse("Should not be PDF", ExportUtilities.isPdfTemplate(new File("foo-html.ftl")));
		assertFalse("Should not be PDF", ExportUtilities.isPdfTemplate(new File("foo.html.ftl")));
		assertFalse("Should not be PDF", ExportUtilities.isPdfTemplate(new File("foo.txt.ftl")));
		assertFalse("Should not be PDF", ExportUtilities.isPdfTemplate(new File("foo.xml.ftl")));

		assertTrue("Should be PDF", ExportUtilities.isPdfTemplate(new File("foo.xslt.ftl")));
		assertTrue("Should be PDF", ExportUtilities.isPdfTemplate(new File("foo-fo.ftl")));
