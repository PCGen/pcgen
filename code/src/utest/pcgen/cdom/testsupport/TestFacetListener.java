/*
 * Extracted from various files originally:
...
public class TestFacetListener<T> implements DataFacetChangeListener<CharID, T>
{
	...
	public void assertEventCount(int a, int r)
	{
		assertEquals(a, getAddCount());
		assertEquals(r, getRemoveCount());
	}
