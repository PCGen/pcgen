...
public class SizeFacetTest
{
	...
	public void testSizesAdvanced()
	{
		...
		Assert.assertEquals(
				"Size increase where none specified wrong",
				0,
				facet.sizesToAdvance(race, 1)
		);
		Assert.assertEquals(
				"Size increase where none specified wrong",
				0,
				facet.sizesToAdvance(race, 2)
		);
		Assert.assertEquals(
				"Size increase where none specified wrong",
				0,
				facet.sizesToAdvance(race, 3)
		);
		Assert.assertEquals(
				"Size increase where none specified wrong",
				0,
				facet.sizesToAdvance(race, 4)
		);
		Assert.assertEquals(
				"Size increase where none specified wrong",
				0,
				facet.sizesToAdvance(race, 5)
		);
		...
		Assert.assertEquals(
				"Size increase pre first change wrong",
				0,
				facet.sizesToAdvance(race, 1)
		);
		Assert.assertEquals(
		...
		Assert.assertEquals(
				"Size increase pre last change wrong",
				1,
				facet.sizesToAdvance(race, 3)
		);
		Assert.assertEquals(
		...
		Assert.assertEquals(
				"Size increase post last change wrong",
				1,
				facet.sizesToAdvance(race, 5)
		);
		Assert.assertEquals(
