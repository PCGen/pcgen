...
public class SpellCastTest extends AbstractGlobalTokenTestCase
{
	...
	{
		Assert.assertFalse(parse("SpellCast"));
		assertNoSideEffects();
	}
	...
	{
		Assert.assertFalse(parse("SpellCast|CLASS.Wizard;LEVEL.1"));
		assertNoSideEffects();
	}
	...
	{
		Assert.assertFalse(parse("SpellCast||2"));
		assertNoSideEffects();
	}
	...
	{
		Assert.assertFalse(parse("SpellCast||CLASS.Wizard;LEVEL.1|1"));
		assertNoSideEffects();
	}
