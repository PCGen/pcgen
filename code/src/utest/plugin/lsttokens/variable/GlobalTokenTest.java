...
public class GlobalTokenTest extends AbstractTokenTestCase<DatasetVariable>
{
	...
	{
		Assert.assertFalse(parse("NUMBER="));
		assertNoSideEffects();
	}
	...
	public void testInvalidDupeVarName() throws PersistenceLayerException
	{
		...
		Assert.assertFalse(parse("STRING=MyVar"));
		assertNoSideEffects();
	}
	...
	{
		Assert.assertFalse(parse("BADFORMAT=Illegal"));
		assertNoSideEffects();
	}
	...
	{
		Assert.assertFalse(parse("NUMBER=Illegal Name!"));
		assertNoSideEffects();
	}
