		...
		extends AbstractGlobalTokenTestCase
{
	...
	public void testInvalidInputAnyItem() throws PersistenceLayerException
	{
		...
		{
			construct(primaryContext, "TestWP1");
			Assert.assertFalse(parse("ALL" + getJoinCharacter() + "TestWP1"));
			assertNoSideEffects();
		}
	}
	...
	public void testInvalidInputItemAny() throws PersistenceLayerException
	{
		...
		{
			construct(primaryContext, "TestWP1");
			Assert.assertFalse(parse("TestWP1" + getJoinCharacter() + "ALL"));
			assertNoSideEffects();
		}
	}
	...
	public void testInvalidInputAnyType() throws PersistenceLayerException
	{
		...
		{
			Assert.assertFalse(parse("ALL" + getJoinCharacter() + "TYPE=TestType"));
			assertNoSideEffects();
		}
	}
	...
	public void testInvalidInputTypeAny() throws PersistenceLayerException
	{
		if (isTypeLegal() && isAllLegal())
		{
			Assert.assertFalse(parse("TYPE=TestType" + getJoinCharacter() + "ALL"));
			assertNoSideEffects();
		}
	}
		...
		throws PersistenceLayerException
	{
		if (isAllLegal())
		{
			...
			Assert.assertTrue(parseSecondary("TestWP1" + getJoinCharacter()
				+ "TestWP2"));
			Assert.assertFalse(parse("TestWP3" + getJoinCharacter() + "ALL"));
			assertNoSideEffects();
		}
	}
