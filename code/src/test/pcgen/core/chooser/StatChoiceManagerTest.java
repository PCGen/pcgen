...
/**
 * {@code StatChoiceManagerTest} test that the StatChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class StatChoiceManagerTest extends AbstractCharacterTestCase {

	/**
	 * Constructs a new {@code StatChoiceManagerTest}.
	 */
	public StatChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		pObj.setChoiceString("NUMCHOICES=1|STAT|Foo|Bar|Baz");
		is(pObj.getChoiceString(), strEq("NUMCHOICES=1|STAT|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("STAT"), "got expected chooser");
