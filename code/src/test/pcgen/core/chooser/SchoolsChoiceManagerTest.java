...
/**
 * {@code SchoolsChoiceManagerTest} test that the SchoolsChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class SchoolsChoiceManagerTest extends AbstractCharacterTestCase {

	/**
	 * Constructs a new {@code SchoolsChoiceManagerTest}.
	 */
	public SchoolsChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		is(choiceManager.typeHandled(), strEq("SCHOOLS"), "got expected chooser");
