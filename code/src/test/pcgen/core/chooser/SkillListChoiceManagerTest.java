/*
 * SkillListChoiceManagerTest.java
...
/**
 * {@code SkillListChoiceManagerTest} test that the SkillListChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class SkillListChoiceManagerTest extends AbstractCharacterTestCase {

	/**
	 * Constructs a new {@code SkillListChoiceManagerTest}.
	 */
	public SkillListChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		is(choiceManager.typeHandled(), strEq("SKILLIST"), "got expected chooser");
