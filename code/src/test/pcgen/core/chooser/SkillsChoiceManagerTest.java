...
/**
 * {@code SkillsChoiceManagerTest} test that the SkillsChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class SkillsChoiceManagerTest extends AbstractCharacterTestCase
{

	/**
	 * Constructs a new {@code SkillsChoiceManagerTest}.
	 */
	public SkillsChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		pObj.setChoiceString("NUMCHOICES=1|SKILLS|Foo|Bar|Baz");
		is(pObj.getChoiceString(), strEq("NUMCHOICES=1|SKILLS|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("SKILLS"), "got expected chooser");
