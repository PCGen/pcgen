...
/**
 * {@code HPChoiceManagerTest} test that the HPChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class HPChoiceManagerTest extends AbstractCharacterTestCase
{

	/**
	 * Constructs a new {@code HPChoiceManagerTest}.
	 */
	public HPChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		pObj.setChoiceString("NUMCHOICES=1|HP|Foo|Bar|Baz");
		is(pObj.getChoiceString(), strEq("NUMCHOICES=1|HP|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("HP"), "got expected chooser");
