/*
 * SkillsNamedToCSkillChoiceManagerTest.java
...
public class SkillsNamedToCSkillChoiceManagerTest extends AbstractCharacterTestCase {

	/**
	 * Constructs a new {@code SkillsNamedToCSkillChoiceManagerTest}.
	 */
	public SkillsNamedToCSkillChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		pObj.setChoiceString("NUMCHOICES=1|SKILLSNAMEDTOCSKILL|Foo|Bar|Baz");
		is(pObj.getChoiceString(), strEq("NUMCHOICES=1|SKILLSNAMEDTOCSKILL|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("SKILLSNAMEDTOCSKILL"), "got expected chooser");
