...
public class SkillsNamedToCSkillChoiceManagerTest extends
		AbstractCharacterTestCase
{
	...
	public void test001()
	{
		...
		is(pObj.getChoiceString(),
			strEq("NUMCHOICES=1|SKILLSNAMEDTOCSKILL|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("SKILLSNAMEDTOCSKILL"),
