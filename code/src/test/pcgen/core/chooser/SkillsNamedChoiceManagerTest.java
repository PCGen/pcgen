/*
 * SkillsNamedChoiceManagerTest.java
...
/**
 * {@code SkillsNamedChoiceManagerTest} test that the SkillsNamedChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class SkillsNamedChoiceManagerTest extends AbstractCharacterTestCase {

	/**
	 * Constructs a new {@code SkillsNamedChoiceManagerTest}.
	 */
	public SkillsNamedChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		pObj.setChoiceString("NUMCHOICES=1|SKILLSNAMED|Foo|Bar|Baz");
		is(pObj.getChoiceString(), strEq("NUMCHOICES=1|SKILLSNAMED|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("SKILLSNAMED"), "got expected chooser");
