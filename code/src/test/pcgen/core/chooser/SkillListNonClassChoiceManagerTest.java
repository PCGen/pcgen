/*
 * SkillListNonClassChoiceManagerTest.java
...
/**
 * {@code SkillListNonClassChoiceManagerTest} test that the SkillListNonClassChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class SkillListNonClassChoiceManagerTest extends AbstractCharacterTestCase {

	/**
	 * Constructs a new {@code SkillListNonClassChoiceManagerTest}.
	 */
	public SkillListNonClassChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		is(pObj.getChoiceString(), strEq("NUMCHOICES=1|NONCLASSSKILLLIST|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("NONCLASSSKILLLIST"), "got expected chooser");
