/*
 * WeaponFocusChoiceManagerTest.java
...
/**
 * {@code WeaponFocusChoiceManagerTest} test that the WeaponFocusChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class WeaponFocusChoiceManagerTest extends AbstractCharacterTestCase {

	/**
	 * Constructs a new {@code WeaponFocusChoiceManagerTest}.
	 */
	public WeaponFocusChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		is(pObj.getChoiceString(), strEq("NUMCHOICES=1|WEAPONFOCUS|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("WEAPONFOCUS"), "got expected chooser");
