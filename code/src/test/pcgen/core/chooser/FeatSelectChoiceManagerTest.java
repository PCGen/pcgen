/*
 * FeatSelectChoiceManagerTest.java
...
/**
 * {@code FeatSelectChoiceManagerTest} test that the FeatSelectChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class FeatSelectChoiceManagerTest extends AbstractCharacterTestCase {

	/**
	 * Constructs a new {@code FeatSelectChoiceManagerTest}.
	 */
	public FeatSelectChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		pObj.setChoiceString("NUMCHOICES=2|FEATSELECT|Foo|Bar|Baz");
		is(pObj.getChoiceString(), strEq("NUMCHOICES=2|FEATSELECT|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("FEATSELECT"), "got expected chooser");
