...
public class SkillsNamedToCCSkillChoiceManagerTest extends
		AbstractCharacterTestCase
{
	...
	public void test001()
	{
		...
		is(pObj.getChoiceString(),
			strEq("NUMCHOICES=1|SKILLSNAMEDTOCCSKILL|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("SKILLSNAMEDTOCCSKILL"),
