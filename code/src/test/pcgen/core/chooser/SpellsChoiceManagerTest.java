...
/**
 * {@code SpellsChoiceManagerTest} test that the SpellsChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class SpellsChoiceManagerTest extends AbstractCharacterTestCase
{

	/**
	 * Constructs a new {@code SpellsChoiceManagerTest}.
	 */
	public SpellsChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		pObj.setChoiceString("NUMCHOICES=1|SPELLS|Foo|Bar|Baz");
		is(pObj.getChoiceString(), strEq("NUMCHOICES=1|SPELLS|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("SPELLS"), "got expected chooser");
