/*
 * SpellClassesChoiceManagerTest.java
...
/**
 * {@code SpellClassesChoiceManagerTest} test that the SpellClassesChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class SpellClassesChoiceManagerTest extends AbstractCharacterTestCase {

	/**
	 * Constructs a new {@code SpellClassesChoiceManagerTest}.
	 */
	public SpellClassesChoiceManagerTest()
	{
		// Do Nothing
	}
	...
	public void test001()
	{
		...
		pObj.setChoiceString("NUMCHOICES=1|SPELLCLASSES|Foo|Bar|Baz");
		is(pObj.getChoiceString(), strEq("NUMCHOICES=1|SPELLCLASSES|Foo|Bar|Baz"));
		...
		is(choiceManager.typeHandled(), strEq("SPELLCLASSES"), "got expected chooser");
