...
/**
 * {@code ProficiencyChoiceManagerTest} test that the RaceChoiceManager class is functioning correctly.
 *
 * @author Andrew Wilson <nuance@sourceforge.net>
 */

public class ProficiencyChoiceManagerTest extends AbstractCharacterTestCase
{

	/**
	 * Constructs a new {@code RaceChoiceManagerTest}.
	 */
	public ProficiencyChoiceManagerTest()
	{
		// Do Nothing
	}
