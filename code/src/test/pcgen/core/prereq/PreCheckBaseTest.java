...
public class PreCheckBaseTest extends AbstractCharacterTestCase
{
	...
	public void testBase() throws Exception
	{
		...
		Assert.assertTrue("Character's Fort save should be 0", PrereqHandler.passes(
			prereq, character, null));

		prereq = factory.parse("PRECHECKBASE:1,Will=2");

		Assert.assertTrue("Character's Will save should be 2", PrereqHandler.passes(
			prereq, character, null));
		...
		Assert.assertFalse("Character's Fort save not 1", PrereqHandler.passes(prereq,
			character, null));
	}
	...
	public void testBonus() throws Exception
	{
		...
		Assert.assertFalse("Character's base Fort save should be 0", PrereqHandler
		...
		Assert.assertFalse("Character's Will save should be 2", PrereqHandler.passes(
			prereq, character, null));
		prereq = factory.parse("PRECHECKBASE:2,Fortitude=1,Will=2");
		Assert.assertFalse("Character's base Fort save not 1", PrereqHandler.passes(
			prereq, character, null));
	}
