...
public class PreLevelTest extends AbstractCharacterTestCase
{
	...
	public void testHD() throws Exception
	{
		...
		prereq = factory.parse("!PRELEVEL:MAX=3");
		Assert.assertTrue("Character doesn't have 3 or more levels", PrereqHandler.passes(
			prereq, character, null));
		...
		Assert.assertTrue("Character doesn't have 4-6 levels", PrereqHandler.passes(
			prereq, character, null));
		...
		prereq = factory.parse("PRELEVEL:MAX=7");
		Assert.assertFalse("Character has no more than 7 levels", PrereqHandler.passes(
			prereq, character, null));
	...
	public void testPCLevel() throws Exception
	{
		...
		prereq = factory.parse("PRELEVEL:MIN=4,MAX=6");
		Assert.assertTrue("Character has 4-6 levels", PrereqHandler.passes(prereq,
				character, null));	
