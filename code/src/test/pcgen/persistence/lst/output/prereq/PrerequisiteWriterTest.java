...
public class PrerequisiteWriterTest extends TestCase
{
	...
	//
		...
		"PRECLASSLEVELMAX:Fighter,SPELLCASTER=2",										"!PRECLASS:1,Fighter=3,SPELLCASTER=3",
		...
		"PREDEITY:Zeus,Odin",															"PREDEITY:1,Zeus,Odin",
...
//		"PREFEAT:2,CHECKMULT,Spell Focus,[Spell Focus(Enchantment)]",					"PREFEAT:2,CHECKMULT,Spell Focus\t!PREFEAT:1,CHECKMULT,Spell Focus (Enchantment)",
		...
		"PREMOVE:Walk=30,Fly=20",														"PREMOVE:1,Walk=30,Fly=20",
		...
		"PRETEMPLATE:Celestial,Fiendish",												"PRETEMPLATE:1,Celestial,Fiendish",
...
//		"PREBASESIZE:Medium",															"PREBASESIZEGTEQ:Medium",
		...
		"!PRECLASSLEVELMAX:Barbarian=1",												"PRECLASS:1,Barbarian=2",
		"PRECLASSLEVELMAX:Rogue=5,Fighter,SPELLCASTER=2,Monk=3",						"!PRECLASS:1,Rogue=6,Fighter=3,SPELLCASTER=3,Monk=4",
