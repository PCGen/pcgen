...
public class PrerequisiteWriterTest extends TestCase
{
	...
	//
		...
		"PREDEITY:Y",																	"PREDEITY:Y",
		"PREDEITY:N",																	"PREDEITY:N",
		"PREDEITY:Zeus,Odin",															"PREMULT:1,[PREDEITY:Zeus],[PREDEITY:Odin]",
