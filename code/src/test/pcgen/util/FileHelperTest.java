...
public class FileHelperTest
{
	...
	public void testRelativePathBack2() throws Exception
	{
		...
		Assert.assertEquals(
				"wrong when back two directories",
				BACK_ONE + BACK_ONE + "bar.txt",
				path
		);
	}
	...
	public void testRelativePathDifferentBranch() throws Exception
	{
		...
		Assert.assertEquals(
				"wrong when on a different branch",
				BACK_ONE + BACK_ONE + "buckle"
						+ File.separator + "my" + File.separator + "shoe.txt",
				path
		);
	}
	...
	public void testRelativePathUnrelated() throws Exception
	{
		...
		Assert.assertEquals(
				"wrong when completely different",
				BACK_ONE + BACK_ONE + BACK_ONE + BACK_ONE + "and"
						+ File.separator + "now" + File.separator + "for" + File
						.separator
