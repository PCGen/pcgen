...
public class EquipmentMigrationTest extends TestCase
{
	...
	{
		Assert.assertEquals("NewKey1", EquipmentMigration.getNewEquipmentKey("OldKey1", new int[]{6,0,0}, gameMode));
		Assert.assertEquals("OldKey1", EquipmentMigration.getNewEquipmentKey("OldKey1", new int[]{6,0,2}, gameMode));
	}
	...
	{
		Assert.assertEquals("OldKey3", EquipmentMigration.getNewEquipmentKey("OldKey3", new int[]{6,0,0}, gameMode));
		Assert.assertEquals("OldKey3", EquipmentMigration.getNewEquipmentKey("OldKey3", new int[]{5,17,0}, gameMode));
	}
