...
class UnencumberedMoveIntegrationTest extends
		AbstractIntegrationTestCase<CDOMObject>
{
	...
	void testRoundRobinSimple() throws PersistenceLayerException
	{
		...
		commit(testCampaign, tc, "MediumArmor");
		commit(modCampaign, tc, "HeavyArmor");
	...
	void testRoundRobinRemove() throws PersistenceLayerException
	{
		...
		TestContext tc = new TestContext();
		commit(testCampaign, tc, "MediumArmor");
		commit(modCampaign, tc, "HeavyLoad|MediumArmor");
		completeRoundRobin(tc);
	}
	...
	void testRoundRobinNoReset() throws PersistenceLayerException
	{
		verifyCleanStart();
		TestContext tc = new TestContext();
		commit(testCampaign, tc, "HeavyLoad|MediumArmor");
