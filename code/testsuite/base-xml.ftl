...
<#macro getarg object subvar><#if object?has_content>${object[subvar]}</#if></#macro>
		...
		<face>
			<face><#if pc.val.os_size!false == true><#if pc.val.face[0] == pc.val.face[1]${pc.val.face[0]} ft.<#else>${pc.val.face[1]} ft. by ${pc.val.face[1]} ft.</#if><#else>${pcstring('FACE')}</#if></face>
