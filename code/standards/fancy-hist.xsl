                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td class='summary-size'>
                                    <xsl:value-of select="/BugCollection/SpotBugsSummary/@total_size"/>
                                </td>
                                <td class='summary-priority-all'>
                                    <xsl:value-of select="/BugCollection/SpotBugsSummary/@total_bugs"/>
                                </td>
                                <td class='summary-priority-1'>
                                    <xsl:value-of select="/BugCollection/SpotBugsSummary/@priority_1"/>
                                </td>
                                <td class='summary-priority-2'>
                                    <xsl:value-of select="/BugCollection/SpotBugsSummary/@priority_2"/>
                                </td>
                                <td class='summary-priority-3'>
                                    <xsl:value-of select="/BugCollection/SpotBugsSummary/@priority_3"/>
                                </td>
                                <td class='summary-priority-4'>
                                    <xsl:value-of select="/BugCollection/SpotBugsSummary/@priority_4"/>
                                </td>
                            </tr>
