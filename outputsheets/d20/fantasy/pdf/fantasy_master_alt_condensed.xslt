	...
	<xsl:template match="melee">
		...
		<fo:table table-layout="fixed" keep-with-next="always" keep-together="always">
			...
			<fo:table-body>
				...
				<xsl:if test="not(w1_h1_p/to_hit = invalidtext/tohit and w1_h1_p/damage = invalidtext/damage and w2_p_oh/to_hit = invalidtext/tohit and w2_p_oh/damage = invalidtext/damage)">
					<fo:table-row keep-with-next.within-column="always">
						<!-- 1HP, 2WP-OH -->
