...
<!-- $Id: csheet_modern_std.xslt 8610 2008-12-15 16:55:16Z karianna $ -->
...
<!-- Insert for Special Attacks, Special Qualities and Talents
-->

<xsl:attribute-set name="special_attacks.title" use-attribute-sets="centre">
	<xsl:attribute name="border-color">black</xsl:attribute>
	<xsl:attribute name="background-color">black</xsl:attribute>
	<xsl:attribute name="color">white</xsl:attribute>
</xsl:attribute-set>

<xsl:attribute-set name="special_attacks.lightline">
	<xsl:attribute name="background-color">white</xsl:attribute>
	<xsl:attribute name="color">black</xsl:attribute>
</xsl:attribute-set>

<xsl:attribute-set name="special_attacks.darkline">
	<xsl:attribute name="background-color">lightgrey</xsl:attribute>
	<xsl:attribute name="color">black</xsl:attribute>
</xsl:attribute-set>

<xsl:attribute-set name="special_qualities.title" use-attribute-sets="centre">
	<xsl:attribute name="border-color">black</xsl:attribute>
	<xsl:attribute name="background-color">black</xsl:attribute>
	<xsl:attribute name="color">white</xsl:attribute>
</xsl:attribute-set>

<xsl:attribute-set name="special_qualities.lightline">
	<xsl:attribute name="background-color">white</xsl:attribute>
	<xsl:attribute name="color">black</xsl:attribute>
</xsl:attribute-set>

<xsl:attribute-set name="special_qualities.darkline">
	<xsl:attribute name="background-color">lightgrey</xsl:attribute>
	<xsl:attribute name="color">black</xsl:attribute>
</xsl:attribute-set>

<xsl:attribute-set name="talents.title" use-attribute-sets="centre">
	<xsl:attribute name="border-color">black</xsl:attribute>
	<xsl:attribute name="background-color">black</xsl:attribute>
	<xsl:attribute name="color">white</xsl:attribute>
</xsl:attribute-set>

<xsl:attribute-set name="talents.lightline">
	<xsl:attribute name="background-color">white</xsl:attribute>
	<xsl:attribute name="color">black</xsl:attribute>
</xsl:attribute-set>

<xsl:attribute-set name="talents.darkline">
	<xsl:attribute name="background-color">lightgrey</xsl:attribute>
	<xsl:attribute name="color">black</xsl:attribute>
</xsl:attribute-set>

<!-- Unknown if we need this in Modern, Fantasy and Modern have different set up 
...
<xsl:template match="special_attacks">
		<xsl:if test="count(ability) &gt; 0" >
			<fo:table table-layout="fixed" space-before="2mm">
				...
				<fo:table-body>
					<fo:table-row keep-with-next.within-column="always">
						<fo:table-cell xsl:use-attribute-sets="special_attacks.title" padding-top="1pt" number-columns-spanned="2">
							<fo:block font-size="9pt">SPECIAL ATTACKS</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<xsl:for-each select="ability">
						...
						<xsl:if test="position() mod 2 = 0">
							<xsl:call-template name="special_attacks.darkline"><xsl:with-param name="content" select="$content"/></xsl:call-template>
						</xsl:if>
						<xsl:if test="position() mod 2 = 1">
							<xsl:call-template name="special_attacks.lightline"><xsl:with-param name="content" select="$content"/></xsl:call-template>
						</xsl:if>
					</xsl:for-each>
				</fo:table-body>
			</fo:table>
...
<xsl:template name="special_attacks.darkline">
		<xsl:param name="content"/>
		<fo:table-row xsl:use-attribute-sets="special_attacks.darkline" keep-with-next.within-column="always">
			<xsl:copy-of select="$content"/>
		</fo:table-row>
</xsl:template>

<xsl:template name="special_attacks.lightline">
		<xsl:param name="content"/>
		<fo:table-row xsl:use-attribute-sets="special_attacks.lightline" keep-with-next.within-column="always">
			<xsl:copy-of select="$content"/>
	</fo:table-row>
</xsl:template>
<!--
...
<xsl:template match="special_qualities">
		<xsl:if test="count(ability) &gt; 0" >
			<fo:table table-layout="fixed" space-before="2mm">
				...
				<fo:table-body>
					<fo:table-row keep-with-next.within-column="always">
						<fo:table-cell xsl:use-attribute-sets="special_qualities.title" padding-top="1pt" number-columns-spanned="2">
							<fo:block font-size="9pt">SPECIAL QUALITIES</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<xsl:for-each select="ability">
						...
						<xsl:if test="position() mod 2 = 0">
							<xsl:call-template name="special_qualities.darkline"><xsl:with-param name="content" select="$content"/></xsl:call-template>
						</xsl:if>
						<xsl:if test="position() mod 2 = 1">
							<xsl:call-template name="special_qualities.lightline"><xsl:with-param name="content" select="$content"/></xsl:call-template>
						</xsl:if>
					</xsl:for-each>
				</fo:table-body>
			</fo:table>
	...
	<xsl:template name="special_qualities.darkline">
		<xsl:param name="content"/>
		<fo:table-row xsl:use-attribute-sets="special_qualities.darkline" keep-with-next.within-column="always">
			<xsl:copy-of select="$content"/>
		</fo:table-row>
	</xsl:template>

	<xsl:template name="special_qualities.lightline">
		<xsl:param name="content"/>
...
<xsl:template match="talents">
			<fo:table table-layout="fixed" space-before="2mm">
				...
				<fo:table-body>
					<fo:table-row keep-with-next.within-column="always">
						<fo:table-cell xsl:use-attribute-sets="talents.title" padding-top="1pt" number-columns-spanned="2">
							<fo:block font-size="9pt">TALENTS</fo:block>
						</fo:table-cell>
					</fo:table-row>
					...
					<xsl:for-each select="ability">
						...
						<xsl:if test="position() mod 2 = 0">
							<xsl:call-template name="talents.darkline"><xsl:with-param name="content" select="$content"/></xsl:call-template>
						</xsl:if>
						<xsl:if test="position() mod 2 = 1">
							<xsl:call-template name="talents.lightline"><xsl:with-param name="content" select="$content"/></xsl:call-template>
						</xsl:if>
					</xsl:for-each>
				</fo:table-body>
			</fo:table>
...
<xsl:template name="talents.darkline">
		<xsl:param name="content"/>
		<fo:table-row xsl:use-attribute-sets="talents.darkline" keep-with-next.within-column="always">
			<xsl:copy-of select="$content"/>
		</fo:table-row>
</xsl:template>

<xsl:template name="talents.lightline">
	<xsl:param name="content"/>
	<fo:table-row xsl:use-attribute-sets="talents.lightline" keep-with-next.within-column="always">
	<xsl:copy-of select="$content"/>
	</fo:table-row>
</xsl:template>
