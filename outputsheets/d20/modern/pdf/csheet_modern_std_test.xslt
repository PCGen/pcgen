...
<!-- $Id: csheet_modern_std_test.xslt -->
<xsl:stylesheet
	version="1.0"
	...
	>
	<xsl:import href="modern_master_std.xslt"/>
	...
	<myAttribs:myAttribs>
		...
		<mutations.title><subattrib centre="" inverse=""/></mutations.title>
		<mutations.border padding="0.5pt"><subattrib border="" inverse=""/></mutations.border>
		<mutations.lightline><subattrib light=""/></mutations.lightline>
		<mutations.darkline><subattrib medium=""/></mutations.darkline>
