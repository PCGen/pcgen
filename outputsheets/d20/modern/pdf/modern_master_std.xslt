...
<xsl:stylesheet version="1.0"
	...
	<xsl:import href="modern_common.xsl"/>
...
<!-- This is for MSRD hold over - need to refactor it back to main -->
		...
		<fo:root xmlns:fo="http://www.w3.org/1999/XSL/Format">
			...
			<fo:page-sequence>
				...
				<!-- End Saga Edition Style -->
					...
					<!--	<xsl:apply-templates select="allegiances" />	-->
			...
			<fo:table-body>
				<fo:table-row>
					...
					<fo:table-cell display-align="center">
						...
						<fo:block font-size="10pt">
							<xsl:value-of select="class_bonus"/>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell display-align="center">
						<fo:block text-align="center" font-size="6pt">+</fo:block>
					...
					<fo:table-cell display-align="center">
						...
						<fo:block font-size="10pt">
							<xsl:value-of select="equipment_bonus"/>
						</fo:block>
					</fo:table-cell>
					<fo:table-cell display-align="center">
						<fo:block text-align="center" font-size="6pt">+</fo:block>
