...
<xsl:stylesheet
	...
	<xsl:import href="fantasy_craft_condensed.xslt"/>
	...
	<myAttribs:myAttribs>
		...
		<language_displays.title><subattrib centre="" inverse=""/></language_displays.title>
		<language_displays.border padding="0.5pt"><subattrib border="" inverse=""/></language_displays.border>
		<language_displays><subattrib  centre="" normal=""/></language_displays>
