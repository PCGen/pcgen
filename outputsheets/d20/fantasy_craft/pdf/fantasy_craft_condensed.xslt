<!-- $Id: fantasycraft_condensed.xslt  -->
...
<!-->						<xsl:apply-templates select="language_displays"/>	-->
...
<!-->						<fo:block font-size="8pt" padding-top="3pt">
				...
				<fo:table-row>
					...
					<fo:table-cell number-columns-spanned="3">
						...
						<fo:block font-size="6pt" padding-top="1pt">RACE / RACETYPE</fo:block>
					</fo:table-cell>
					<fo:table-cell/>
					<fo:table-cell>
						<xsl:call-template name="attrib">
...
<!-- Third ROW Text-->
				<fo:table-row>
					...
					<fo:table-cell>
						...
						<fo:block font-size="6pt" padding-top="1pt">Point Buy</fo:block>	
					</fo:table-cell>
					<fo:table-cell/>
				</fo:table-row>	
			</fo:table-body>
...
====================================
====================================
	TEMPLATE - LANGUAGES DISPLAY
====================================
====================================-->
	<xsl:template match="language_displays">
		<!-- BEGIN Languages Table -->
		<xsl:call-template name="list">
			<xsl:with-param name="attribute" select="'language_displays'"/>
			<xsl:with-param name="title" select="'Languages'"/>
			<xsl:with-param name="value" select="." />
		</xsl:call-template>
		<!-- END Languages Table -->
...
====================================
====================================
	TEMPLATE - NPC QUALITIES
====================================
====================================-->
	<xsl:template match="npc_qualities">
		<xsl:if test="count(npc_quality) &gt; 0">
			<xsl:call-template name="bold.list">
				<xsl:with-param name="attribute" select="'npc_qualities'" />
				<xsl:with-param name="title" select="'NPC Qualities'" />
				<xsl:with-param name="list" select="npc_quality"/>
				<xsl:with-param name="name.tag" select="'name'"/>
				<xsl:with-param name="desc.tag" select="'description'"/>
			</xsl:call-template>
		</xsl:if>
