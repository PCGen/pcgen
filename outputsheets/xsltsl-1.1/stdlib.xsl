...
<xsl:template match="foo">
  <xsl:call-template name="str:subst">
    ...
    <chapter>
      ...
      <itemizedlist>
	<listitem>
	  <para>Gzip'd tarball: <ulink url="http://prdownloads.sourceforge.net/xsltsl/xsltsl-1.1;.tar.gz">http://prdownloads.sourceforge.net/xsltsl/xsltsl-1.1;.tar.gz</ulink></para>
	</listitem>
	<listitem>
	  <para>Zip file: <ulink url="http://prdownloads.sourceforge.net/xsltsl/xsltsl-1.1;.zip">http://prdownloads.sourceforge.net/xsltsl/xsltsl-1.1;.zip</ulink></para>
	</listitem>
      </itemizedlist>
    </chapter>
