...
public interface Graph<N, ET extends Edge<N>>
{
	...
	/**
	 * Returns true if there are Edges that are adjacent (connected) to the given Node.
	 * Returns false if there are no adjacent edges or the given Node is not in this
	 * Graph.
	 * 
	 * @param node
