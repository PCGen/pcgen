...
/**
 * A ColumnFormatManager is a FormatManager that defines the format of a TableColumn.
 * 
 * @param <T>
 *            The Format of the contents of a Column defined by this ColumnFormatManager
 *            in a DataTable
 */
public class ColumnFormatManager<T> implements FormatManager<TableColumn>
{
	...
	/**
	 * The Converter used to look up TableColumn objects.
	 */
	...
	/**
	 * Constructs a new ColumnFormatManager that will use the underlying FormatManager to
	 * construct and look up TableColumn objects of the format of the given FormatManager.
	 * 
	 * @param columnFormat
	 *            The ReferenceConverter used to look up TableColumn objects
	 * @param formatManager
	 *            The Format of TableColumns referred to by this ColumnFormatManager
	 */
	public ColumnFormatManager(ReferenceConverter<TableColumn> columnFormat,
		FormatManager<T> formatManager)
	{
		this.converter = Objects.requireNonNull(columnFormat);
	...
	{
		return converter.convert(inputStr);
	}

	@Override
	public Indirect<TableColumn> convertIndirect(String inputStr)
	{
		return converter.convertIndirect(inputStr);
	}
